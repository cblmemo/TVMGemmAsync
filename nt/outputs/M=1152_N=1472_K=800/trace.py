...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v9, v10, v11 = sch.sample_perfect_tile(loop=l6, n=3, max_innermost_factor=16, decision=[18, 4, 16])
  v12, v13, v14 = sch.sample_perfect_tile(loop=l7, n=3, max_innermost_factor=16, decision=[23, 8, 8])
  v15, v16 = sch.sample_perfect_tile(loop=l8, n=2, max_innermost_factor=8, decision=[200, 4])
  ...
  v26, v27, v28 = sch.sample_perfect_tile(loop=l18, n=3, max_innermost_factor=16, decision=[2, 1, 2])
  ...
  v45, v46 = sch.sample_perfect_tile(loop=l44, n=2, max_innermost_factor=16, decision=[16, 1])
  ...
  v55, v56 = sch.sample_perfect_tile(loop=l54, n=2, max_innermost_factor=16, decision=[1, 8])
