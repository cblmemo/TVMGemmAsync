...
class Module:
    ...
    def main(A: T.Buffer[(3072, 512), "float32"], B: T.Buffer[(3072, 768), "float32"], Y: T.Buffer[(512, 768), "float32"]):
        ...
        A_shared_dyn_local = T.alloc_buffer([3072, 512], dtype="float32", scope="local")
                    ...
                    for i_2_0_init in T.unroll(1):
                        for i_2_1_init in T.unroll(4):
                            with T.block("Y_init"):
                                ...
                                v_j = T.axis.spatial(768, i_0_j_0_fused % 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 4 * 12 + j_2_init)
                                T.reads()
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(128, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.vectorized(2):
                            with T.block("A_shared.dyn"):
                                v0 = T.axis.spatial(3072, k_0 * 4 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 8 * 16 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 8 * 2 + ax0_ax1_fused_2) // 64)
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(128, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.serial(3):
                            with T.block("B_shared.dyn"):
                                v0 = T.axis.spatial(3072, k_0 * 4 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 8 * 24 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 8 * 3 + ax0_ax1_fused_2) // 96)
                                v1 = T.axis.spatial(768, i_0_j_0_fused % 8 * 96 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 8 * 24 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 8 * 3 + ax0_ax1_fused_2) % 96)
                                T.reads(B[v0, v1])
                        ...
                        for ax0, ax1_0 in T.grid(1, 3):
                            for ax1_1 in T.vectorized(4):
                                with T.block("B_shared.dyn_local"):
                                    v0 = T.axis.spatial(3072, ax0 + k_0 * 4 + k_1)
                                    v1 = T.axis.spatial(768, i_0_j_0_fused % 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 4 * 12 + ax1_0 * 4 + ax1_1)
                            ...
                            for i_2_0 in T.unroll(1):
                                for i_2_1 in T.vectorized(4):
                                    with T.block("Y_update"):
                                        ...
                                        v_j = T.axis.spatial(768, i_0_j_0_fused % 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 4 * 12 + j_2)
