...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v9, v10, v11 = sch.sample_perfect_tile(loop=l6, n=3, max_innermost_factor=16, decision=[5, 25, 8])
  v12, v13, v14 = sch.sample_perfect_tile(loop=l7, n=3, max_innermost_factor=16, decision=[25, 5, 16])
  v15, v16 = sch.sample_perfect_tile(loop=l8, n=2, max_innermost_factor=16, decision=[500, 6])
  ...
  v26, v27, v28 = sch.sample_perfect_tile(loop=l18, n=3, max_innermost_factor=16, decision=[25, 1, 1])
  v29, v30 = sch.sample_perfect_tile(loop=l21, n=2, max_innermost_factor=16, decision=[5, 1])
