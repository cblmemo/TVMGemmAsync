...
class Module:
    ...
    def main(A: T.Buffer[(256, 512), "float32"], B: T.Buffer[(256, 384), "float32"], Y: T.Buffer[(512, 384), "float32"]):
        ...
        A_shared_dyn_local = T.alloc_buffer([256, 512], dtype="float32", scope="local")
                    ...
                    for i_2_0_init in T.unroll(1):
                        for i_2_1_init in T.unroll(4):
                            with T.block("Y_init"):
                                ...
                                v_i = T.axis.spatial(512, i_0_j_0_fused // 8 * 64 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 64 // 2 * 2 + (i_2_0_init * 4 + i_2_1_init))
                                v_j = T.axis.spatial(384, i_0_j_0_fused % 8 * 48 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 64 * 24 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 12 + j_2_init)
                                T.reads()
                                T.writes(Y_local[v_i, v_j])
                                Y_local[v_i, v_j] = T.float32(0)
                for k_0 in T.serial(32, annotations={"software_pipeline_async_stages":[0, 1], "software_pipeline_order":[0, 1, 3, 2, 4], "software_pipeline_stage":[0, 0, 2, 3, 3]}):
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(128, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.vectorized(4):
                            with T.block("A_shared.dyn"):
                                v0 = T.axis.spatial(256, k_0 * 8 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 4 * 16 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 4 * 4 + ax0_ax1_fused_2) // 64)
                                v1 = T.axis.spatial(512, i_0_j_0_fused // 8 * 64 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 4 * 16 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 4 * 4 + ax0_ax1_fused_2) % 64)
                                T.reads(A[v0, v1])
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(128, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.serial(3):
                            with T.block("B_shared.dyn"):
                                v0 = T.axis.spatial(256, k_0 * 8 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 4 * 12 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 4 * 3 + ax0_ax1_fused_2) // 48)
                                v1 = T.axis.spatial(384, i_0_j_0_fused % 8 * 48 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 4 * 12 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 4 * 3 + ax0_ax1_fused_2) % 48)
                                T.reads(B[v0, v1])
                        ...
                        for ax0, ax1_0 in T.grid(1, 1):
                            for ax1_1 in T.vectorized(4):
                                with T.block("A_shared.dyn_local"):
                                    ...
                                    v1 = T.axis.spatial(512, i_0_j_0_fused // 8 * 64 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 64 // 2 * 2 + (ax1_0 * 4 + ax1_1))
                        ...
                        for ax0, ax1_0 in T.grid(1, 3):
                            for ax1_1 in T.vectorized(4):
                                with T.block("B_shared.dyn_local"):
                                    v0 = T.axis.spatial(256, ax0 + k_0 * 8 + k_1)
                                    v1 = T.axis.spatial(384, i_0_j_0_fused % 8 * 48 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 64 * 24 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 12 + ax1_0 * 4 + ax1_1)
                            ...
                            for i_2_0 in T.unroll(1):
                                for i_2_1 in T.vectorized(4):
                                    with T.block("Y_update"):
                                        ...
                                        v_i = T.axis.spatial(512, i_0_j_0_fused // 8 * 64 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 64 // 2 * 2 + (i_2_0 * 4 + i_2_1))
                                        v_j = T.axis.spatial(384, i_0_j_0_fused % 8 * 48 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 64 * 24 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 12 + j_2)
                    ...
                    for ax1_0 in T.serial(3):
                        for ax1_1 in T.vectorized(4):
                            with T.block("Y_local"):
                                v0 = T.axis.spatial(512, i_0_j_0_fused // 8 * 64 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 64 // 2 * 2 + ax0)
                                v1 = T.axis.spatial(384, i_0_j_0_fused % 8 * 48 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 64 * 24 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 12 + ax1_0 * 4 + ax1_1)
