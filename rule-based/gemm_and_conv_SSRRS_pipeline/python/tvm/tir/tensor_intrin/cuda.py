...
PIPELINED_DEDICATED_FLOAT32_INTRIN = "pipelined_mma_float32"
TensorIntrin.register(
    PIPELINED_DEDICATED_FLOAT32_INTRIN,
    *get_wmma_sync_intrin(1, 1, 1, "float32", "float32", False),
)

PIPELINED_DEDICATED_FLOAT32_TRANS_INTRIN = "pipelined_mma_float32_trans"
TensorIntrin.register(
    PIPELINED_DEDICATED_FLOAT32_TRANS_INTRIN,
    *get_wmma_sync_intrin(1, 1, 1, "float32", "float32", True),
)
