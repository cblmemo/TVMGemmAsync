...
class Module:
    ...
    def main(A: T.Buffer((1024, 1024), "float16"), B: T.Buffer((1024, 1024), "float16"), Y: T.Buffer((1024, 1024), "float16")):
        ...
        for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init, b in T.grid(2, 2, 4, 2, 2):
            Y_reindex_m16n8k8_matrixC_2[ax0_0_3_init * 32 + ax0_0_4_init * 8 + ax1_0_3_init * 4 + ax1_0_4_init * 2 + b] = T.Broadcast(T.float16(0), 2)
        with T.decl_buffer((6144,), "float16", data=A_reindex_shared_dyn, scope="shared.dyn") as A_reindex_shared_dyn_1:
            ...
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(4):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = A_1[blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_ax1_fused_0 * 32768 + threadIdx_y * 16384 + threadIdx_x // 2 * 1024 + threadIdx_x % 2 * 8:blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_ax1_fused_0 * 32768 + threadIdx_y * 16384 + threadIdx_x // 2 * 1024 + threadIdx_x % 2 * 8 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(2):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = B_1[ax0_ax1_fused_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + threadIdx_x % 8 * 8:ax0_ax1_fused_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + threadIdx_x % 8 * 8 + 8]
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(4):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 2048:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 2048 + 8] = A_1[blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_ax1_fused_0 * 32768 + threadIdx_y * 16384 + threadIdx_x // 2 * 1024 + threadIdx_x % 2 * 8 + 16:blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_ax1_fused_0 * 32768 + threadIdx_y * 16384 + threadIdx_x // 2 * 1024 + threadIdx_x % 2 * 8 + 16 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(2):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 1024:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 1024 + 8] = B_1[ax0_ax1_fused_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + threadIdx_x % 8 * 8 + 16384:ax0_ax1_fused_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + threadIdx_x % 8 * 8 + 16384 + 8]
            ...
            for ax2_0_0 in range(62):
                with T.attr(0, "async_commit_queue_scope", 0):
                    with T.attr(0, "async_scope", 1):
                        for ax0_ax1_fused_0 in range(4):
                            A_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 2048 + ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:(ax2_0_0 + 2) % 3 * 2048 + ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = A_1[blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_ax1_fused_0 * 32768 + threadIdx_y * 16384 + threadIdx_x // 2 * 1024 + ax2_0_0 * 16 + threadIdx_x % 2 * 8 + 32:blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_ax1_fused_0 * 32768 + threadIdx_y * 16384 + threadIdx_x // 2 * 1024 + ax2_0_0 * 16 + threadIdx_x % 2 * 8 + 32 + 8]
                    T.attr(0, "async_scope", 1)
                    for ax0_ax1_fused_0 in range(2):
                        B_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 1024 + ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:(ax2_0_0 + 2) % 3 * 1024 + ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = B_1[ax2_0_0 * 16384 + ax0_ax1_fused_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + threadIdx_x % 8 * 8 + 32768:ax2_0_0 * 16384 + ax0_ax1_fused_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + threadIdx_x % 8 * 8 + 32768 + 8]
                with T.attr(0, "async_wait_queue_scope", 0):
                    T.attr(0, "async_wait_inflight_count", 1)
                    for ax0_0 in range(4):
                    ...
                    for ax0_0_3, ax1_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4, 2):
                        cse_var_2: T.int32 = ax1_0_3 * 4
                        cse_var_1: T.int32 = ax1_0_4 * 2
                        T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 16 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_2 + cse_var_1, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 32 + ax0_0_4 * 8 + cse_var_2 + cse_var_1, T.bool(False))
                for ax0_0 in range(4):
                ...
                for ax0_0_3, ax1_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4, 2):
                    ...
                    T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 16 + ax0_0_4 * 4 + 32, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_4 + cse_var_3 + 8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 32 + ax0_0_4 * 8 + cse_var_4 + cse_var_3, T.bool(False))
            with T.attr(0, "async_wait_queue_scope", 0):
                ...
                T.ptx_ldmatrix("float16", T.bool(True), 4, ".b16", B_reindex_shared_dyn_m16n8k8_matrixB, 8, T.tvm_access_ptr(T.type_annotation("float16"), B_reindex_shared_dyn, threadIdx_y * 32 + 2560, 512, 1), threadIdx_x % 8 * 64 + threadIdx_x // 8 * 8)
                for ax0_0_3, ax1_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4, 2):
                    cse_var_6: T.int32 = ax1_0_3 * 4
                    cse_var_5: T.int32 = ax1_0_4 * 2
                    T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 16 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_6 + cse_var_5, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 32 + ax0_0_4 * 8 + cse_var_6 + cse_var_5, T.bool(False))
            for ax0_0 in range(4):
                T.ptx_ldmatrix("float16", T.bool(False), 4, ".b16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), A_reindex_shared_dyn, ax0_0 * 512, 512, 1), threadIdx_x * 16)
            T.ptx_ldmatrix("float16", T.bool(True), 4, ".b16", B_reindex_shared_dyn_m16n8k8_matrixB, 0, T.tvm_access_ptr(T.type_annotation("float16"), B_reindex_shared_dyn, threadIdx_y * 32, 512, 1), threadIdx_x % 8 * 64 + threadIdx_x // 8 * 8)
            for ax0_0_3, ax1_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4, 2):
                ...
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 16 + ax0_0_4 * 4 + 32, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_8 + cse_var_7 + 8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 32 + ax0_0_4 * 8 + cse_var_8 + cse_var_7, T.bool(False))
            for ax0_0 in range(4):
            ...
            for ax0_0_3, ax1_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4, 2):
                ...
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 16 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_10 + cse_var_9, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 32 + ax0_0_4 * 8 + cse_var_10 + cse_var_9, T.bool(False))
            for ax0_0_3, ax1_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4, 2):
                cse_var_12: T.int32 = ax1_0_3 * 4
                cse_var_11: T.int32 = ax1_0_4 * 2
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 16 + ax0_0_4 * 4 + 32, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_12 + cse_var_11 + 8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 32 + ax0_0_4 * 8 + cse_var_12 + cse_var_11, T.bool(False))
        ...
        for ax0_0 in range(16):
            ...
            for ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 in range(8):
                ...
                Y_1[blockIdx_x // 8 * 262144 + blockIdx_y // 2 * 131072 + ax0_0 * 8192 + threadIdx_y * 4096 + threadIdx_x // 8 * 1024 + blockIdx_x % 8 * 128 + blockIdx_y % 2 * 64 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 8 + threadIdx_x % 8] = B_reindex_shared_dyn_1[ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 64 + threadIdx_y * 32 + threadIdx_x]
