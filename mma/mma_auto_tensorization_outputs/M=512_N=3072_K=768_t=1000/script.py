        ...
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(32, thread="blockIdx.x"):
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(4, thread="blockIdx.y"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(2, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(4, 12, 1, 1):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(32, ax0_0_1_ax1_0_1_fused * 8 + ax0_0_2_ax1_0_2_fused * 4 + ax0_0_3_init + ax0_0_4_init)
                            v1_o = T.axis.spatial(384, ax1_0_4_init + ax0_0_0_ax1_0_0_fused * 12 + ax1_0_3_init)
                            T.reads()
                    ...
                    for ax2_0_0 in T.serial(24, annotations={"software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 3, 2, 4], "software_pipeline_stage": [0, 0, 1, 2, 2]}):
                        ...
                        for ax2_0_1 in T.serial(4, annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.block("A_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                    v0_o = T.axis.spatial(16, ax0_0_1_ax1_0_1_fused * 4 + ax0_0_2_ax1_0_2_fused * 2 + ax0_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 3):
                                with T.block("B_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                    ...
                                    v1_o = T.axis.spatial(96, ax0_0_0_ax1_0_0_fused * 3 + ax1_0)
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(4, 12, 1, 1, 1):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(32, ax0_0_1_ax1_0_1_fused * 8 + ax0_0_2_ax1_0_2_fused * 4 + ax0_0_3 + ax0_0_4)
                                    v1_o = T.axis.spatial(384, ax1_0_4 + ax0_0_0_ax1_0_0_fused * 12 + ax1_0_3)
