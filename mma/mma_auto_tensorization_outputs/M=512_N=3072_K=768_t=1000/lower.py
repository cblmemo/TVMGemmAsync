...
class Module:
    ...
    def main(A: T.Buffer((512, 768), "float16"), B: T.Buffer((768, 3072), "float16"), Y: T.Buffer((512, 3072), "float16")):
        ...
        for ax0_0_3_init, ax1_0_3_init, b in T.grid(4, 12, 2):
            Y_reindex_m16n8k8_matrixC_2[ax0_0_3_init * 24 + ax1_0_3_init * 2 + b] = T.Broadcast(T.float16(0), 2)
        with T.decl_buffer((12288,), "float16", data=A_reindex_shared_dyn, scope="shared.dyn") as A_reindex_shared_dyn_1:
            ...
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(8):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = A_1[blockIdx_y * 98304 + ax0_ax1_fused_0 * 12288 + threadIdx_y * 6144 + threadIdx_x // 4 * 768 + threadIdx_x % 4 * 8:blockIdx_y * 98304 + ax0_ax1_fused_0 * 12288 + threadIdx_y * 6144 + threadIdx_x // 4 * 768 + threadIdx_x % 4 * 8 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(6):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = B_1[(ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) // 96 * 3072 + blockIdx_x * 96 + (ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) % 96:(ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) // 96 * 3072 + blockIdx_x * 96 + (ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) % 96 + 8]
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(8):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 4096:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 4096 + 8] = A_1[blockIdx_y * 98304 + ax0_ax1_fused_0 * 12288 + threadIdx_y * 6144 + threadIdx_x // 4 * 768 + threadIdx_x % 4 * 8 + 32:blockIdx_y * 98304 + ax0_ax1_fused_0 * 12288 + threadIdx_y * 6144 + threadIdx_x // 4 * 768 + threadIdx_x % 4 * 8 + 32 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(6):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 3072:ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 3072 + 8] = B_1[(ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) // 96 * 3072 + blockIdx_x * 96 + (ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) % 96 + 98304:(ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) // 96 * 3072 + blockIdx_x * 96 + (ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8) % 96 + 98304 + 8]
            ...
            for ax2_0_0 in range(22):
                with T.attr(0, "async_commit_queue_scope", 0):
                    with T.attr(0, "async_scope", 1):
                        for ax0_ax1_fused_0 in range(8):
                            A_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 4096 + ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8:(ax2_0_0 + 2) % 3 * 4096 + ax0_ax1_fused_0 * 512 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = A_1[blockIdx_y * 98304 + ax0_ax1_fused_0 * 12288 + threadIdx_y * 6144 + threadIdx_x // 4 * 768 + ax2_0_0 * 32 + threadIdx_x % 4 * 8 + 64:blockIdx_y * 98304 + ax0_ax1_fused_0 * 12288 + threadIdx_y * 6144 + threadIdx_x // 4 * 768 + ax2_0_0 * 32 + threadIdx_x % 4 * 8 + 64 + 8]
                    T.attr(0, "async_scope", 1)
                    for ax0_ax1_fused_0 in range(6):
                        cse_var_1: T.int32 = ax0_ax1_fused_0 * 512
                        B_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 3072 + cse_var_1 + threadIdx_y * 256 + threadIdx_x * 8:(ax2_0_0 + 2) % 3 * 3072 + cse_var_1 + threadIdx_y * 256 + threadIdx_x * 8 + 8] = B_1[ax2_0_0 * 98304 + (cse_var_1 + threadIdx_y * 256 + threadIdx_x * 8) // 96 * 3072 + blockIdx_x * 96 + (cse_var_1 + threadIdx_y * 256 + threadIdx_x * 8) % 96 + 196608:ax2_0_0 * 98304 + (cse_var_1 + threadIdx_y * 256 + threadIdx_x * 8) // 96 * 3072 + blockIdx_x * 96 + (cse_var_1 + threadIdx_y * 256 + threadIdx_x * 8) % 96 + 196608 + 8]
                with T.attr(0, "async_wait_queue_scope", 0):
                    T.attr(0, "async_wait_inflight_count", 1)
                    for ax2_0_1 in range(3):
                        ...
                        for ax0_0_3, ax1_0_3 in T.grid(4, 12):
                            cse_var_3: T.int32 = ax2_0_1 % 2
                            cse_var_2: T.int32 = ax1_0_3 * 2
                            T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_3 * 16 + ax0_0_3 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_3 * 24 + cse_var_2, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 24 + cse_var_2, T.bool(False))
                for ax0_0 in range(2):
                ...
                for ax0_0_3, ax1_0_3 in T.grid(4, 12):
                    ...
                    T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 4 + 16, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_4 + 24, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 24 + cse_var_4, T.bool(False))
            with T.attr(0, "async_wait_queue_scope", 0):
                ...
                for ax2_0_1 in range(3):
                    ...
                    for ax0_0_3, ax1_0_3 in T.grid(4, 12):
                        cse_var_6: T.int32 = ax2_0_1 % 2
                        cse_var_5: T.int32 = ax1_0_3 * 2
                        T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_6 * 16 + ax0_0_3 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_6 * 24 + cse_var_5, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 24 + cse_var_5, T.bool(False))
            for ax0_0 in range(2):
            ...
            for ax0_0_3, ax1_0_3 in T.grid(4, 12):
                ...
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 4 + 16, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_7 + 24, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 24 + cse_var_7, T.bool(False))
            for ax2_0_1 in range(3):
                for ax0_0 in range(2):
                ...
                for ax0_0_3, ax1_0_3 in T.grid(4, 12):
                    ...
                    T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_9 * 16 + ax0_0_3 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_9 * 24 + cse_var_8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 24 + cse_var_8, T.bool(False))
            for ax0_0_3, ax1_0_3 in T.grid(4, 12):
                cse_var_10: T.int32 = ax1_0_3 * 2
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 4 + 16, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_10 + 24, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 24 + cse_var_10, T.bool(False))
        ...
        for ax0_0 in range(8):
            ...
            for ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 in range(24):
                ...
                Y_1[blockIdx_y * 393216 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 // 12 * 196608 + ax0_0 * 24576 + threadIdx_y * 12288 + threadIdx_x // 8 * 3072 + blockIdx_x * 96 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 % 12 * 8 + threadIdx_x % 8] = B_reindex_shared_dyn_1[ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 64 + threadIdx_y * 32 + threadIdx_x]
