                ...
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(2, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(2, 2, 1, 2):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 8 * 16 + ax0_0_1_ax1_0_1_fused * 4 + ax0_0_2_ax1_0_2_fused * 2 + ax0_0_3_init + ax0_0_4_init)
                            v1_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused % 8 * 4 + ax1_0_3_init * 2 + ax1_0_4_init)
                            T.reads()
                    ...
                    for ax2_0_0 in T.serial(8, annotations={"software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 3, 2, 4], "software_pipeline_stage": [0, 0, 1, 2, 2]}):
                        with T.block("A_reindex_shared.dyn"):
                            ...
                            T.reads(A[v0 // 8 * 256 + v1 * 64:v0 // 8 * 256 + v1 * 64 + 64, v2 * 80:v2 * 80 + 80])
                            T.writes(A_reindex_shared_dyn[v0 // 8 * 256 + v1 * 64:v0 // 8 * 256 + v1 * 64 + 64, v2 * 80:v2 * 80 + 80])
                            T.block_attr({"auto_copy": 1, "buffer_dim_align": [[0, 0, 32, 8]], "vector_bytes": 16})
                            for ax0, ax1 in T.grid(64, 80):
                                A_reindex_shared_dyn[v0 // 8 * 256 + v1 * 64 + ax0, v2 * 80 + ax1] = A[v0 // 8 * 256 + v1 * 64 + ax0, v2 * 80 + ax1]
                        with T.block("B_reindex_shared.dyn"):
                            v0, v1 = T.axis.remap("SS", [ax2_0_0, ax0_0_0_ax1_0_0_fused])
                            T.reads(B[v0 * 80:v0 * 80 + 80, v1 % 8 * 32:v1 % 8 * 32 + 32])
                            T.writes(B_reindex_shared_dyn[v0 * 80:v0 * 80 + 80, v1 % 8 * 32:v1 % 8 * 32 + 32])
                            T.block_attr({"auto_copy": 1, "buffer_dim_align": [[0, 0, 32, 8]], "vector_bytes": 16})
                            for ax0, ax1 in T.grid(80, 32):
                                B_reindex_shared_dyn[v0 * 80 + ax0, v1 % 8 * 32 + ax1] = B[v0 * 80 + ax0, v1 % 8 * 32 + ax1]
                        for ax2_0_1 in T.serial(10, annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                            for ax0_0, ax1_0 in T.grid(1, 1):
                                with T.block("A_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                    v0_o = T.axis.spatial(16, ax0_0_0_ax1_0_0_fused // 8 * 8 + ax0_0_1_ax1_0_1_fused * 2 + ax0_0_2_ax1_0_2_fused + ax0_0)
                                    v1_o = T.axis.spatial(80, ax2_0_0 * 10 + ax2_0_1 + ax1_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 1):
                                with T.block("B_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                    v0_o = T.axis.spatial(80, ax2_0_0 * 10 + ax2_0_1 + ax0_0)
                                    v1_o = T.axis.spatial(8, ax0_0_0_ax1_0_0_fused % 8 + ax1_0)
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(2, 2, 1, 1, 2):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 8 * 16 + ax0_0_1_ax1_0_1_fused * 4 + ax0_0_2_ax1_0_2_fused * 2 + ax0_0_3 + ax0_0_4)
                                    v1_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused % 8 * 4 + ax1_0_3 * 2 + ax1_0_4)
                                    v2_o = T.axis.reduce(80, ax2_0_0 * 10 + ax2_0_1 + ax2_0_2)
                    ...
                    with T.block("Y_reindex_m16n8k8.matrixC"):
                        ...
                        T.reads(Y_reindex_m16n8k8_matrixC[v0 // 8 * 256 + v1 * 64 + v2 * 32:v0 // 8 * 256 + v1 * 64 + v2 * 32 + 32, v0 % 8 * 32:v0 % 8 * 32 + 32])
                        T.writes(Y[v0 // 8 * 256 + v1 * 64 + v2 * 32:v0 // 8 * 256 + v1 * 64 + v2 * 32 + 32, v0 % 8 * 32:v0 % 8 * 32 + 32])
                        T.block_attr({"auto_copy": 1})
                        for ax0, ax1 in T.grid(32, 32):
                            Y[v0 // 8 * 256 + v1 * 64 + v2 * 32 + ax0, v0 % 8 * 32 + ax1] = Y_reindex_m16n8k8_matrixC[v0 // 8 * 256 + v1 * 64 + v2 * 32 + ax0, v0 % 8 * 32 + ax1]
