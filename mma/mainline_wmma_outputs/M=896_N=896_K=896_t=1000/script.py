...
class Module:
    ...
    def main(A: T.Buffer((896, 896), "float16"), B: T.Buffer((896, 896), "float16"), Y: T.Buffer((896, 896), "float16")):
        ...
        # with T.block("root"):
        Y_reindex_shared_dyn = T.alloc_buffer((56, 14, 1, 4, 16, 16), "float16", scope="shared.dyn")
        Y_reindex_shared_dyn_wmma_accumulator = T.alloc_buffer((56, 14, 1, 4, 16, 16), "float16", scope="wmma.accumulator")
        A_reindex_shared_dyn = T.alloc_buffer((896, 896), "float16", scope="shared.dyn")
        B_reindex_shared_dyn = T.alloc_buffer((896, 896), "float16", scope="shared.dyn")
        A_reindex_shared_dyn_wmma_matrix_a = T.alloc_buffer((896, 896), "float16", scope="wmma.matrix_a")
        B_reindex_shared_dyn_wmma_matrix_b = T.alloc_buffer((896, 896), "float16", scope="wmma.matrix_b")
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(28, thread="blockIdx.y", annotations={"pragma_auto_unroll_max_step": 16, "pragma_unroll_explicit": 1}):
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(7, thread="blockIdx.x"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(4, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(1, 4, 1, 1):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused + ax0_0_3_init + ax0_0_4_init)
                            v1_o = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused % 2 * 28 + ax0_0_1_ax1_0_1_fused * 4 + ax1_0_3_init + ax1_0_4_init)
                            T.reads()
                            T.writes(Y_reindex_shared_dyn_wmma_accumulator[v0_o, v1_o // 4, 0, v1_o % 4, 0:16, 0:16])
                            ...
                            C = T.match_buffer(Y_reindex_shared_dyn_wmma_accumulator[v0_o, v1_o // 4, 0, v1_o % 4, 0:16, 0:16], (16, 16), "float16", strides=("C_s0", "C_s1"), scope="wmma.accumulator", offset_factor=16)
                                ...
                                for ax0_ax1_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                    for ax0_ax1_fused_3 in T.vectorized(8):
                                        with T.block("A_reindex_shared.dyn"):
                                            v0 = T.axis.spatial(896, ax0_0_0_ax1_0_0_fused // 2 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 256 + ax0_ax1_fused_2 * 8 + ax0_ax1_fused_3) // 32)
                                            v1 = T.axis.spatial(896, ax2_0_0 * 32 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 256 + ax0_ax1_fused_2 * 8 + ax0_ax1_fused_3) % 32)
                                            T.reads(A[v0, v1])
                                ...
                                for ax0_ax1_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                    for ax0_ax1_fused_3 in T.vectorized(8):
                                        with T.block("B_reindex_shared.dyn"):
                                            v0 = T.axis.spatial(896, ax2_0_0 * 32 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 256 + ax0_ax1_fused_2 * 8 + ax0_ax1_fused_3) // 64)
                                            v1 = T.axis.spatial(896, ax0_0_0_ax1_0_0_fused % 2 * 448 + ax0_0_1_ax1_0_1_fused * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 256 + ax0_ax1_fused_2 * 8 + ax0_ax1_fused_3) % 64)
                                            T.reads(B[v0, v1])
                        ...
                        for ax2_0_1 in range(1):
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("A_reindex_shared.dyn_wmma.matrix_a_o"):
                                    v0_o = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused + ax0_0)
                                    v1_o = T.axis.spatial(56, ax2_0_0 * 2 + ax1_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(2, 4):
                                with T.block("B_reindex_shared.dyn_wmma.matrix_b_o"):
                                    v0_o = T.axis.spatial(56, ax2_0_0 * 2 + ax0_0)
                                    v1_o = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused % 2 * 28 + ax0_0_1_ax1_0_1_fused * 4 + ax1_0)
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(1, 4, 2, 1, 1):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused + ax0_0_3 + ax0_0_4)
                                    v1_o = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused % 2 * 28 + ax0_0_1_ax1_0_1_fused * 4 + ax1_0_3 + ax1_0_4)
                                    v2_o = T.axis.reduce(56, ax2_0_0 * 2 + ax2_0_1 * 2 + ax2_0_2)
                                    T.reads(Y_reindex_shared_dyn_wmma_accumulator[v0_o, v1_o // 4, 0, v1_o % 4, 0:16, 0:16], A_reindex_shared_dyn_wmma_matrix_a[v0_o * 16:v0_o * 16 + 16, v2_o * 16:v2_o * 16 + 16], B_reindex_shared_dyn_wmma_matrix_b[v2_o * 16:v2_o * 16 + 16, v1_o * 16:v1_o * 16 + 16])
                                    T.writes(Y_reindex_shared_dyn_wmma_accumulator[v0_o, v1_o // 4, 0, v1_o % 4, 0:16, 0:16])
                                    T.block_attr({"meta_schedule.thread_extent_high_inclusive": 1024, "meta_schedule.thread_extent_low_inclusive": 32, "warp_execution": 1})
                    ...
                    for ax0_ax1_fused in T.thread_binding(4, thread="threadIdx.y"):
                        for ax2_1, ax3 in T.grid(1, 4):
                            with T.block("Y_reindex_shared.dyn_wmma.accumulator_o"):
                                v0 = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused // 2 * 4 + ax0_ax1_fused)
                                v1 = T.axis.spatial(14, ax0_0_0_ax1_0_0_fused % 2 * 7 + ax0_0_1_ax1_0_1_fused)
                        ...
                        for ax0_ax1_ax3_ax4_ax5_fused_1 in T.thread_binding(4, thread="threadIdx.y"):
                            for ax0_ax1_ax3_ax4_ax5_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                with T.block("Y_reindex_shared.dyn"):
                                    v0 = T.axis.spatial(56, ax0_0_0_ax1_0_0_fused // 2 * 4 + (ax0_ax1_ax3_ax4_ax5_fused_0 * 128 + ax0_ax1_ax3_ax4_ax5_fused_1 * 32 + ax0_ax1_ax3_ax4_ax5_fused_2) // 1024)
                                    v1 = T.axis.spatial(14, ax0_0_0_ax1_0_0_fused % 2 * 7 + ax0_0_1_ax1_0_1_fused)
                                    v2 = T.axis.spatial(1, ax2)
                                    v3 = T.axis.spatial(4, (ax0_ax1_ax3_ax4_ax5_fused_0 * 128 + ax0_ax1_ax3_ax4_ax5_fused_1 * 32 + ax0_ax1_ax3_ax4_ax5_fused_2) % 1024 // 256)
                                    v4 = T.axis.spatial(16, (ax0_ax1_ax3_ax4_ax5_fused_0 * 128 + ax0_ax1_ax3_ax4_ax5_fused_1 * 32 + ax0_ax1_ax3_ax4_ax5_fused_2) % 256 // 16)
                                    v5 = T.axis.spatial(16, (ax0_ax1_ax3_ax4_ax5_fused_0 * 128 + ax0_ax1_ax3_ax4_ax5_fused_1 * 32 + ax0_ax1_ax3_ax4_ax5_fused_2) % 16)
                                    T.reads(Y_reindex_shared_dyn[v0, v1, v2, v3, v4, v5])
                                    T.writes(Y[v4 + v0 * 16, v5 + v3 * 16 + v1 * 64])
                                    Y[v4 + v0 * 16, v5 + v3 * 16 + v1 * 64] = Y_reindex_shared_dyn[v0, v1, v2, v3, v4, v5]
