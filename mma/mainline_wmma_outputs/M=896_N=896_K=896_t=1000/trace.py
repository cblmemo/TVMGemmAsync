...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v24, v25, v26, v27, v28 = sch.sample_perfect_tile(loop=l21, n=5, max_innermost_factor=4, decision=[14, 1, 4, 1, 1])
  l29, l30, l31, l32, l33 = sch.split(loop=l21, factors=[v24, v25, v26, v27, v28], preserve_unit_iters=True)
  v34, v35, v36, v37, v38 = sch.sample_perfect_tile(loop=l22, n=5, max_innermost_factor=4, decision=[2, 7, 1, 4, 1])
  l39, l40, l41, l42, l43 = sch.split(loop=l22, factors=[v34, v35, v36, v37, v38], preserve_unit_iters=True)
  v44, v45, v46 = sch.sample_perfect_tile(loop=l23, n=3, max_innermost_factor=4, decision=[28, 1, 2])
  ...
  l159, l160, l161 = sch.split(loop=l158, factors=[None, 4, 32], preserve_unit_iters=True)
  ...
  l167, l168, l169, l170 = sch.split(loop=l166, factors=[None, 4, 32, 8], preserve_unit_iters=True)
  ...
  l176, l177, l178, l179 = sch.split(loop=l175, factors=[None, 4, 32, 8], preserve_unit_iters=True)
  ...
  sch.annotate(block_or_loop=l196, ann_key="pragma_auto_unroll_max_step", ann_val=16)
  sch.annotate(block_or_loop=l196, ann_key="pragma_unroll_explicit", ann_val=1)
  ...
  b240 = sch.get_block(name="Y_o", func_name="main")
  ...
  b252 = sch.get_block(name="Y_o_init", func_name="main")
  ...
  b255 = sch.get_block(name="Y_o_update", func_name="main")
  ...
  b256 = sch.get_block(name="Y_reindex_shared.dyn_wmma.accumulator_o", func_name="main")
