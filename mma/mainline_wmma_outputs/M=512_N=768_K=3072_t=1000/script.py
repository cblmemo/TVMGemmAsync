...
class Module:
    ...
    def main(A: T.Buffer((512, 3072), "float16"), B: T.Buffer((3072, 768), "float16"), Y: T.Buffer((512, 768), "float16")):
        ...
        # with T.block("root"):
        Y_reindex_shared_dyn = T.alloc_buffer((16, 48, 2, 1, 16, 16), "float16", scope="shared.dyn")
        Y_reindex_shared_dyn_wmma_accumulator = T.alloc_buffer((16, 48, 2, 1, 16, 16), "float16", scope="wmma.accumulator")
        A_reindex_shared_dyn = T.alloc_buffer((512, 3072), "float16", scope="shared.dyn")
        B_reindex_shared_dyn = T.alloc_buffer((3072, 768), "float16", scope="shared.dyn")
        A_reindex_shared_dyn_wmma_matrix_a = T.alloc_buffer((512, 3072), "float16", scope="wmma.matrix_a")
        B_reindex_shared_dyn_wmma_matrix_b = T.alloc_buffer((3072, 768), "float16", scope="wmma.matrix_b")
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(12, thread="blockIdx.y"):
                ...
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(8, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(1, 1, 2, 1):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 6 * 16 + ax0_0_1_ax1_0_1_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused // 4 * 2 + ax0_0_3_init * 2 + ax0_0_4_init)
                            v1_o = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused % 6 * 8 + ax0_0_1_ax1_0_1_fused % 2 * 4 + ax0_0_2_ax1_0_2_fused % 4 + ax1_0_3_init + ax1_0_4_init)
                            T.reads()
                            T.writes(Y_reindex_shared_dyn_wmma_accumulator[v0_o // 2, v1_o, v0_o % 2, 0, 0:16, 0:16])
                            ...
                            C = T.match_buffer(Y_reindex_shared_dyn_wmma_accumulator[v0_o // 2, v1_o, v0_o % 2, 0, 0:16, 0:16], (16, 16), "float16", strides=("C_s0", "C_s1"), scope="wmma.accumulator", offset_factor=16)
                                ...
                                for ax0_ax1_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                    for ax0_ax1_fused_3 in T.vectorized(4):
                                        with T.block("A_reindex_shared.dyn"):
                                            v0 = T.axis.spatial(512, ax0_0_0_ax1_0_0_fused // 6 * 256 + ax0_0_1_ax1_0_1_fused // 2 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 128 + ax0_ax1_fused_2 * 4 + ax0_ax1_fused_3) // 64)
                                            v1 = T.axis.spatial(3072, ax2_0_0 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 128 + ax0_ax1_fused_2 * 4 + ax0_ax1_fused_3) % 64)
                                            T.reads(A[v0, v1])
                                ...
                                for ax0_ax1_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                    for ax0_ax1_fused_3 in T.vectorized(4):
                                        with T.block("B_reindex_shared.dyn"):
                                            v0 = T.axis.spatial(3072, ax2_0_0 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 128 + ax0_ax1_fused_2 * 4 + ax0_ax1_fused_3) // 64)
                                            v1 = T.axis.spatial(768, ax0_0_0_ax1_0_0_fused % 6 * 128 + ax0_0_1_ax1_0_1_fused % 2 * 64 + (ax0_ax1_fused_0 * 1024 + ax0_ax1_fused_1 * 128 + ax0_ax1_fused_2 * 4 + ax0_ax1_fused_3) % 64)
                                            T.reads(B[v0, v1])
                        ...
                        for ax2_0_1 in range(1):
                            for ax0_0, ax1_0 in T.grid(2, 4):
                                with T.block("A_reindex_shared.dyn_wmma.matrix_a_o"):
                                    v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 6 * 16 + ax0_0_1_ax1_0_1_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused // 4 * 2 + ax0_0)
                                    v1_o = T.axis.spatial(192, ax2_0_0 * 4 + ax1_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(4, 1):
                                with T.block("B_reindex_shared.dyn_wmma.matrix_b_o"):
                                    v0_o = T.axis.spatial(192, ax2_0_0 * 4 + ax0_0)
                                    v1_o = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused % 6 * 8 + ax0_0_1_ax1_0_1_fused % 2 * 4 + ax0_0_2_ax1_0_2_fused % 4 + ax1_0)
                                    ...
                                    T.tvm_load_matrix_sync(C.data, 16, 16, 16, C.elem_offset // C.strides[0] // 16 * (C.strides[0] // 16) + C.elem_offset % C.strides[0] // 16, T.tvm_access_ptr(T.type_annotation("float16"), A_1.data, A_1.elem_offset, A_1.strides[0] * 16, 1), A_1.strides[0], "row_major")
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(1, 1, 4, 2, 1):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 6 * 16 + ax0_0_1_ax1_0_1_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused // 4 * 2 + ax0_0_3 * 2 + ax0_0_4)
                                    v1_o = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused % 6 * 8 + ax0_0_1_ax1_0_1_fused % 2 * 4 + ax0_0_2_ax1_0_2_fused % 4 + ax1_0_3 + ax1_0_4)
                                    v2_o = T.axis.reduce(192, ax2_0_0 * 4 + ax2_0_1 * 4 + ax2_0_2)
                                    T.reads(Y_reindex_shared_dyn_wmma_accumulator[v0_o // 2, v1_o, v0_o % 2, 0, 0:16, 0:16], A_reindex_shared_dyn_wmma_matrix_a[v0_o * 16:v0_o * 16 + 16, v2_o * 16:v2_o * 16 + 16], B_reindex_shared_dyn_wmma_matrix_b[v2_o * 16:v2_o * 16 + 16, v1_o * 16:v1_o * 16 + 16])
                                    T.writes(Y_reindex_shared_dyn_wmma_accumulator[v0_o // 2, v1_o, v0_o % 2, 0, 0:16, 0:16])
                                    T.block_attr({"meta_schedule.thread_extent_high_inclusive": 1024, "meta_schedule.thread_extent_low_inclusive": 32, "warp_execution": 1})
                    ...
                    for ax0_ax1_fused in T.thread_binding(8, thread="threadIdx.y"):
                        for ax2_1, ax3 in T.grid(1, 1):
                            with T.block("Y_reindex_shared.dyn_wmma.accumulator_o"):
                                v0 = T.axis.spatial(16, ax0_0_0_ax1_0_0_fused // 6 * 8 + ax0_0_1_ax1_0_1_fused // 2 * 2 + ax0_ax1_fused // 4)
                                v1 = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused % 6 * 8 + ax0_0_1_ax1_0_1_fused % 2 * 4 + ax0_ax1_fused % 4)
                            ...
                            for ax0_ax1_ax3_ax4_ax5_fused_2 in T.thread_binding(32, thread="threadIdx.x"):
                                for ax0_ax1_ax3_ax4_ax5_fused_3 in T.vectorized(4):
                                    with T.block("Y_reindex_shared.dyn"):
                                        v0 = T.axis.spatial(16, ax0_0_0_ax1_0_0_fused // 6 * 8 + ax0_0_1_ax1_0_1_fused // 2 * 2 + (ax0_ax1_ax3_ax4_ax5_fused_0 * 1024 + ax0_ax1_ax3_ax4_ax5_fused_1 * 128 + ax0_ax1_ax3_ax4_ax5_fused_2 * 4 + ax0_ax1_ax3_ax4_ax5_fused_3) // 1024)
                                        v1 = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused % 6 * 8 + ax0_0_1_ax1_0_1_fused % 2 * 4 + (ax0_ax1_ax3_ax4_ax5_fused_0 * 1024 + ax0_ax1_ax3_ax4_ax5_fused_1 * 128 + ax0_ax1_ax3_ax4_ax5_fused_2 * 4 + ax0_ax1_ax3_ax4_ax5_fused_3) % 1024 // 256)
                                        ...
                                        T.writes(Y[v4 + v2 * 16 + v0 * 32, v5 + v1 * 16])
                                        Y[v4 + v2 * 16 + v0 * 32, v5 + v1 * 16] = Y_reindex_shared_dyn[v0, v1, v2, v3, v4, v5]
