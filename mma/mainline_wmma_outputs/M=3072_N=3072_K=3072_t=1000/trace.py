...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v24, v25, v26, v27, v28 = sch.sample_perfect_tile(loop=l21, n=5, max_innermost_factor=4, decision=[16, 1, 1, 12, 1])
  l29, l30, l31, l32, l33 = sch.split(loop=l21, factors=[v24, v25, v26, v27, v28], preserve_unit_iters=True)
  v34, v35, v36, v37, v38 = sch.sample_perfect_tile(loop=l22, n=5, max_innermost_factor=4, decision=[1, 16, 4, 3, 1])
  l39, l40, l41, l42, l43 = sch.split(loop=l22, factors=[v34, v35, v36, v37, v38], preserve_unit_iters=True)
  v44, v45, v46 = sch.sample_perfect_tile(loop=l23, n=3, max_innermost_factor=4, decision=[96, 2, 1])
  ...
  l177, l178, l179, l180 = sch.split(loop=l176, factors=[None, 4, 32, 8], preserve_unit_iters=True)
  ...
  sch.annotate(block_or_loop=l197, ann_key="pragma_auto_unroll_max_step", ann_val=1024)
  ...
  sch.annotate(block_or_loop=l212, ann_key="pragma_auto_unroll_max_step", ann_val=1024)
  ...
  sch.annotate(block_or_loop=l219, ann_key="pragma_auto_unroll_max_step", ann_val=1024)
  ...
  sch.annotate(block_or_loop=l229, ann_key="pragma_auto_unroll_max_step", ann_val=1024)
  ...
  sch.annotate(block_or_loop=l235, ann_key="pragma_auto_unroll_max_step", ann_val=1024)
