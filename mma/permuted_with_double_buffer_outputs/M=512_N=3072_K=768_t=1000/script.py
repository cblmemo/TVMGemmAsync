        ...
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(8, thread="blockIdx.x"):
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(24, thread="blockIdx.y"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(4, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(1, 1, 2, 8):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 2 * 8 + ax0_0_2_ax1_0_2_fused * 2 + ax0_0_3_init * 2 + ax0_0_4_init)
                            v1_o = T.axis.spatial(384, ax0_0_0_ax1_0_0_fused % 2 * 192 + ax0_0_1_ax1_0_1_fused * 8 + ax1_0_3_init * 8 + ax1_0_4_init)
                            T.reads()
                    ...
                    for ax2_0_0 in T.serial(24, annotations={"software_pipeline_order": [0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage": [0, 0, 0, 0, 0, 1, 1]}):
                        ...
                        with T.block("B_reindex_shared.dyn"):
                            ...
                            T.reads(B[v0 * 32:v0 * 32 + 32, v1 % 2 * 1536 + v2 * 64:v1 % 2 * 1536 + v2 * 64 + 64])
                            T.writes(B_reindex_shared_dyn[v0 * 32:v0 * 32 + 32, v1 % 2 * 1536 + v2 * 64:v1 % 2 * 1536 + v2 * 64 + 64])
                            ...
                            for ax0, ax1 in T.grid(32, 64):
                                B_reindex_shared_dyn[v0 * 32 + ax0, v1 % 2 * 1536 + v2 * 64 + ax1] = B[v0 * 32 + ax0, v1 % 2 * 1536 + v2 * 64 + ax1]
                        for ax2_0_1 in T.serial(2, annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("A_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                    v0_o = T.axis.spatial(16, ax0_0_0_ax1_0_0_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused + ax0_0)
                                    v1_o = T.axis.spatial(96, ax2_0_0 * 4 + ax2_0_1 * 2 + ax1_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(2, 2):
                                with T.block("B_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                    v0_o = T.axis.spatial(96, ax2_0_0 * 4 + ax2_0_1 * 2 + ax0_0)
                                    v1_o = T.axis.spatial(96, ax0_0_0_ax1_0_0_fused % 2 * 48 + ax0_0_1_ax1_0_1_fused * 2 + ax1_0)
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(1, 1, 2, 2, 8):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(32, ax0_0_0_ax1_0_0_fused // 2 * 8 + ax0_0_2_ax1_0_2_fused * 2 + ax0_0_3 * 2 + ax0_0_4)
                                    v1_o = T.axis.spatial(384, ax0_0_0_ax1_0_0_fused % 2 * 192 + ax0_0_1_ax1_0_1_fused * 8 + ax1_0_3 * 8 + ax1_0_4)
                                    v2_o = T.axis.reduce(96, ax2_0_0 * 4 + ax2_0_1 * 2 + ax2_0_2)
                    ...
                    with T.block("Y_reindex_m16n8k8.matrixC"):
                        ...
                        T.reads(Y_reindex_m16n8k8_matrixC[v0 // 2 * 128 + v1 * 32:v0 // 2 * 128 + v1 * 32 + 32, v0 % 2 * 1536 + v2 * 64:v0 % 2 * 1536 + v2 * 64 + 64])
                        T.writes(Y[v0 // 2 * 128 + v1 * 32:v0 // 2 * 128 + v1 * 32 + 32, v0 % 2 * 1536 + v2 * 64:v0 % 2 * 1536 + v2 * 64 + 64])
                        T.block_attr({"auto_copy": 1})
                        for ax0, ax1 in T.grid(32, 64):
                            Y[v0 // 2 * 128 + v1 * 32 + ax0, v0 % 2 * 1536 + v2 * 64 + ax1] = Y_reindex_m16n8k8_matrixC[v0 // 2 * 128 + v1 * 32 + ax0, v0 % 2 * 1536 + v2 * 64 + ax1]
