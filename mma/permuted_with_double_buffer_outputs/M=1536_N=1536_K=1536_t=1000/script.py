...
class Module:
    ...
    def main(A: T.Buffer((1536, 1536), "float16"), B: T.Buffer((1536, 1536), "float16"), Y: T.Buffer((1536, 1536), "float16")):
        ...
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(24, thread="blockIdx.x"):
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(4, thread="blockIdx.y"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(4, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(6, 4, 1, 2):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(96, ax0_0_0_ax1_0_0_fused // 12 * 48 + ax0_0_1_ax1_0_1_fused * 12 + ax0_0_2_ax1_0_2_fused // 2 * 6 + ax0_0_3_init + ax0_0_4_init)
                            v1_o = T.axis.spatial(192, ax0_0_0_ax1_0_0_fused % 12 * 16 + ax0_0_2_ax1_0_2_fused % 2 * 8 + ax1_0_3_init * 2 + ax1_0_4_init)
                            T.reads()
                    ...
                    for ax2_0_0 in T.serial(96, annotations={"software_pipeline_order": [0, 3, 1, 4, 5, 2, 6], "software_pipeline_stage": [0, 0, 0, 0, 0, 1, 1]}):
                        with T.block("A_reindex_shared.dyn"):
                            ...
                            T.reads(A[v0 // 12 * 768 + v1 * 192:v0 // 12 * 768 + v1 * 192 + 192, v2 * 16:v2 * 16 + 16])
                            T.writes(A_reindex_shared_dyn[v0 // 12 * 768 + v1 * 192:v0 // 12 * 768 + v1 * 192 + 192, v2 * 16:v2 * 16 + 16])
                            ...
                            for ax0, ax1 in T.grid(192, 16):
                                A_reindex_shared_dyn[v0 // 12 * 768 + v1 * 192 + ax0, v2 * 16 + ax1] = A[v0 // 12 * 768 + v1 * 192 + ax0, v2 * 16 + ax1]
                        with T.block("B_reindex_shared.dyn"):
                            v0, v1 = T.axis.remap("SS", [ax2_0_0, ax0_0_0_ax1_0_0_fused])
                            T.reads(B[v0 * 16:v0 * 16 + 16, v1 % 12 * 128:v1 % 12 * 128 + 128])
                            T.writes(B_reindex_shared_dyn[v0 * 16:v0 * 16 + 16, v1 % 12 * 128:v1 % 12 * 128 + 128])
                            ...
                            for ax0, ax1 in T.grid(16, 128):
                                B_reindex_shared_dyn[v0 * 16 + ax0, v1 % 12 * 128 + ax1] = B[v0 * 16 + ax0, v1 % 12 * 128 + ax1]
                        for ax2_0_1 in T.serial(2, annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                            for ax0_0, ax1_0 in T.grid(3, 1):
                                with T.block("A_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                    v0_o = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused // 12 * 24 + ax0_0_1_ax1_0_1_fused * 6 + ax0_0_2_ax1_0_2_fused // 2 * 3 + ax0_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("B_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                    ...
                                    v1_o = T.axis.spatial(48, ax0_0_0_ax1_0_0_fused % 12 * 4 + ax0_0_2_ax1_0_2_fused % 2 * 2 + ax1_0)
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(6, 4, 1, 1, 2):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(96, ax0_0_0_ax1_0_0_fused // 12 * 48 + ax0_0_1_ax1_0_1_fused * 12 + ax0_0_2_ax1_0_2_fused // 2 * 6 + ax0_0_3 + ax0_0_4)
                                    v1_o = T.axis.spatial(192, ax0_0_0_ax1_0_0_fused % 12 * 16 + ax0_0_2_ax1_0_2_fused % 2 * 8 + ax1_0_3 * 2 + ax1_0_4)
                    ...
                    with T.block("Y_reindex_m16n8k8.matrixC"):
                        ...
                        T.reads(Y_reindex_m16n8k8_matrixC[v0 // 12 * 768 + v1 * 192 + v2 // 2 * 96:v0 // 12 * 768 + v1 * 192 + v2 // 2 * 96 + 96, v0 % 12 * 128 + v2 % 2 * 64:v0 % 12 * 128 + v2 % 2 * 64 + 64])
                        T.writes(Y[v0 // 12 * 768 + v1 * 192 + v2 // 2 * 96:v0 // 12 * 768 + v1 * 192 + v2 // 2 * 96 + 96, v0 % 12 * 128 + v2 % 2 * 64:v0 % 12 * 128 + v2 % 2 * 64 + 64])
                        T.block_attr({"auto_copy": 1})
                        for ax0, ax1 in T.grid(96, 64):
                            Y[v0 // 12 * 768 + v1 * 192 + v2 // 2 * 96 + ax0, v0 % 12 * 128 + v2 % 2 * 64 + ax1] = Y_reindex_m16n8k8_matrixC[v0 // 12 * 768 + v1 * 192 + v2 // 2 * 96 + ax0, v0 % 12 * 128 + v2 % 2 * 64 + ax1]
