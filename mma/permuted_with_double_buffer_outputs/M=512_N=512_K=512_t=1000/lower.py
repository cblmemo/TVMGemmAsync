    ...
    def main(A: T.Buffer((512, 512), "float16"), B: T.Buffer((512, 512), "float16"), Y: T.Buffer((512, 512), "float16")):
        ...
        with T.decl_buffer((8192,), "float16", data=A_reindex_shared_dyn, scope="shared.dyn") as A_reindex_shared_dyn_1:
            ...
            for ax0_ax1_fused_0_cache in range(4):
                A_reindex_shared_dyn_local_2[ax0_ax1_fused_0_cache * 9] = A_1[blockIdx_y // 4 * 32768 + ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + threadIdx_x % 8 * 8:blockIdx_y // 4 * 32768 + ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + threadIdx_x % 8 * 8 + 8]
            ...
            for ax0_ax1_fused_0_cache in range(4):
                B_reindex_shared_dyn_local_2[ax0_ax1_fused_0_cache * 9] = B_1[ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + blockIdx_x * 256 + blockIdx_y % 4 * 64 + threadIdx_x % 8 * 8:ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + blockIdx_x * 256 + blockIdx_y % 4 * 64 + threadIdx_x % 8 * 8 + 8]
            ...
            for ax2_0_0 in range(7):
                for ax0_ax1_fused_0_cache in range(4):
                    A_reindex_shared_dyn_local_2[ax0_ax1_fused_0_cache * 9] = A_1[blockIdx_y // 4 * 32768 + ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + ax2_0_0 * 64 + threadIdx_x % 8 * 8 + 64:blockIdx_y // 4 * 32768 + ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + ax2_0_0 * 64 + threadIdx_x % 8 * 8 + 64 + 8]
                for ax0_ax1_fused_0_cache in range(4):
                    B_reindex_shared_dyn_local_2[ax0_ax1_fused_0_cache * 9] = B_1[ax2_0_0 * 32768 + ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + blockIdx_x * 256 + blockIdx_y % 4 * 64 + threadIdx_x % 8 * 8 + 32768:ax2_0_0 * 32768 + ax0_ax1_fused_0_cache * 8192 + threadIdx_y * 2048 + threadIdx_x // 8 * 512 + blockIdx_x * 256 + blockIdx_y % 4 * 64 + threadIdx_x % 8 * 8 + 32768 + 8]
                for ax1_0 in range(4):
        ...
        for ax0_0 in range(4):
            ...
            for ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 in range(8):
                ...
                Y_1[blockIdx_y // 4 * 32768 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 // 4 * 16384 + ax0_0 * 4096 + threadIdx_y % 2 * 2048 + threadIdx_x // 8 * 512 + blockIdx_x * 256 + blockIdx_y % 4 * 64 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 % 4 * 16 + threadIdx_y // 2 * 8 + threadIdx_x % 8] = A_reindex_shared_dyn_1[ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 128 + threadIdx_y * 32 + threadIdx_x]
