...
class Module:
    ...
    def main(A: T.Buffer((896, 896), "float16"), B: T.Buffer((896, 896), "float16"), Y: T.Buffer((896, 896), "float16")):
        ...
        blockIdx_x = T.launch_thread("blockIdx.x", 49)
        ...
        for ax0_0_3_init, ax0_0_4_init, ax1_0_4_init, b in T.grid(2, 2, 4, 2):
            Y_reindex_m16n8k8_matrixC_2[ax0_0_3_init * 16 + ax0_0_4_init * 8 + ax1_0_4_init * 2 + b] = T.Broadcast(T.float16(0), 2)
        with T.decl_buffer((6144,), "float16", data=A_reindex_shared_dyn, scope="shared.dyn") as A_reindex_shared_dyn_1:
            ...
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(2):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 8] = A_1[blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_ax1_fused_0 * 28672 + threadIdx_y * 7168 + threadIdx_x // 4 * 896 + threadIdx_x % 4 * 8:blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_ax1_fused_0 * 28672 + threadIdx_y * 7168 + threadIdx_x // 4 * 896 + threadIdx_x % 4 * 8 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(4):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 8] = B_1[ax0_ax1_fused_0 * 7168 + threadIdx_y * 1792 + threadIdx_x // 16 * 896 + blockIdx_x % 7 * 128 + threadIdx_x % 16 * 8:ax0_ax1_fused_0 * 7168 + threadIdx_y * 1792 + threadIdx_x // 16 * 896 + blockIdx_x % 7 * 128 + threadIdx_x % 16 * 8 + 8]
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(2):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 2048:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 2048 + 8] = A_1[blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_ax1_fused_0 * 28672 + threadIdx_y * 7168 + threadIdx_x // 4 * 896 + threadIdx_x % 4 * 8 + 32:blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_ax1_fused_0 * 28672 + threadIdx_y * 7168 + threadIdx_x // 4 * 896 + threadIdx_x % 4 * 8 + 32 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(4):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 4096:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 4096 + 8] = B_1[ax0_ax1_fused_0 * 7168 + threadIdx_y * 1792 + threadIdx_x // 16 * 896 + blockIdx_x % 7 * 128 + threadIdx_x % 16 * 8 + 28672:ax0_ax1_fused_0 * 7168 + threadIdx_y * 1792 + threadIdx_x // 16 * 896 + blockIdx_x % 7 * 128 + threadIdx_x % 16 * 8 + 28672 + 8]
            ...
            for ax2_0_0 in range(26):
                with T.attr(0, "async_commit_queue_scope", 0):
                    with T.attr(0, "async_scope", 1):
                        for ax0_ax1_fused_0 in range(2):
                            A_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 2048 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8:(ax2_0_0 + 2) % 3 * 2048 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 8] = A_1[blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_ax1_fused_0 * 28672 + threadIdx_y * 7168 + threadIdx_x // 4 * 896 + ax2_0_0 * 32 + threadIdx_x % 4 * 8 + 64:blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_ax1_fused_0 * 28672 + threadIdx_y * 7168 + threadIdx_x // 4 * 896 + ax2_0_0 * 32 + threadIdx_x % 4 * 8 + 64 + 8]
                    T.attr(0, "async_scope", 1)
                    for ax0_ax1_fused_0 in range(4):
                        B_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 4096 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8:(ax2_0_0 + 2) % 3 * 4096 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 8] = B_1[ax2_0_0 * 28672 + ax0_ax1_fused_0 * 7168 + threadIdx_y * 1792 + threadIdx_x // 16 * 896 + blockIdx_x % 7 * 128 + threadIdx_x % 16 * 8 + 57344:ax2_0_0 * 28672 + ax0_ax1_fused_0 * 7168 + threadIdx_y * 1792 + threadIdx_x // 16 * 896 + blockIdx_x % 7 * 128 + threadIdx_x % 16 * 8 + 57344 + 8]
                with T.attr(0, "async_wait_queue_scope", 0):
                    T.attr(0, "async_wait_inflight_count", 1)
                    for ax2_0_1 in range(3):
                        for ax0_0 in range(2):
                            cse_var_1: T.int32 = ax2_0_1 + 1
                            T.ptx_ldmatrix("float16", T.bool(False), 4, ".b16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_1 % 2 * 16 + ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), A_reindex_shared_dyn, ax2_0_0 % 3 * 2048, 1024, 1), ax0_0 * 1024 + threadIdx_x * 32 + T.bitwise_xor(cse_var_1, threadIdx_x % 8 // 2) * 8)
                        ...
                        for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4):
                            cse_var_3: T.int32 = ax2_0_1 % 2
                            cse_var_2: T.int32 = ax1_0_4 * 2
                            T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_3 * 16 + ax0_0_3 * 8 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_3 * 8 + cse_var_2, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_2, T.bool(False))
                for ax0_0 in range(2):
                    T.ptx_ldmatrix("float16", T.bool(False), 4, ".b16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), A_reindex_shared_dyn, (ax2_0_0 + 1) % 3 * 2048, 1024, 1), ax0_0 * 1024 + threadIdx_x * 32 + T.bitwise_xor(0, threadIdx_x % 8 // 2) * 8)
            ...
            with T.attr(0, "async_wait_queue_scope", 0):
                ...
                for ax2_0_1 in range(3):
                    for ax0_0 in range(2):
                        ...
                        T.ptx_ldmatrix("float16", T.bool(False), 4, ".b16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_5 % 2 * 16 + ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), A_reindex_shared_dyn, 4096, 1024, 1), ax0_0 * 1024 + threadIdx_x * 32 + T.bitwise_xor(cse_var_5, threadIdx_x % 8 // 2) * 8)
                    ...
                    for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4):
                        ...
                        T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_7 * 16 + ax0_0_3 * 8 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_7 * 8 + cse_var_6, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_6, T.bool(False))
            for ax0_0 in range(2):
                T.ptx_ldmatrix("float16", T.bool(False), 4, ".b16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), A_reindex_shared_dyn, 0, 1024, 1), ax0_0 * 1024 + threadIdx_x * 32 + T.bitwise_xor(0, threadIdx_x % 8 // 2) * 8)
            T.ptx_ldmatrix("float16", T.bool(True), 4, ".b16", B_reindex_shared_dyn_m16n8k8_matrixB, 0, T.tvm_access_ptr(T.type_annotation("float16"), B_reindex_shared_dyn, 0, 1024, 1), threadIdx_x % 8 * 128 + threadIdx_y // 2 * 64 + T.bitwise_xor(threadIdx_y % 2 * 4 + threadIdx_x // 8, threadIdx_x % 8) * 8)
            for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4):
                cse_var_8: T.int32 = ax1_0_4 * 2
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 8 + ax0_0_4 * 4 + 16, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_8 + 8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_8, T.bool(False))
            for ax2_0_1 in range(3):
                for ax0_0 in range(2):
                    cse_var_9: T.int32 = ax2_0_1 + 1
                    T.ptx_ldmatrix("float16", T.bool(False), 4, ".b16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_9 % 2 * 16 + ax0_0 * 8, T.tvm_access_ptr(T.type_annotation("float16"), A_reindex_shared_dyn, 0, 1024, 1), ax0_0 * 1024 + threadIdx_x * 32 + T.bitwise_xor(cse_var_9, threadIdx_x % 8 // 2) * 8)
                T.ptx_ldmatrix("float16", T.bool(True), 4, ".b16", B_reindex_shared_dyn_m16n8k8_matrixB, (ax2_0_1 + 1) % 2 * 8, T.tvm_access_ptr(T.type_annotation("float16"), B_reindex_shared_dyn, 0, 1024, 1), ax2_0_1 * 1024 + threadIdx_x % 8 * 128 + threadIdx_y // 2 * 64 + T.bitwise_xor(threadIdx_y % 2 * 4 + threadIdx_x // 8, threadIdx_x % 8) * 8 + 1024)
                for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4):
                    cse_var_11: T.int32 = ax2_0_1 % 2
                    cse_var_10: T.int32 = ax1_0_4 * 2
                    T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_11 * 16 + ax0_0_3 * 8 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_11 * 8 + cse_var_10, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_10, T.bool(False))
            for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(2, 2, 4):
                cse_var_12: T.int32 = ax1_0_4 * 2
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 8 + ax0_0_4 * 4 + 16, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_12 + 8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_12, T.bool(False))
        ...
        for ax0_0 in range(8):
            ...
            for ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 in range(8):
                ...
                Y_1[blockIdx_x // 7 * 114688 + blockIdx_y * 57344 + ax0_0 * 7168 + threadIdx_y % 2 * 3584 + threadIdx_x // 8 * 896 + blockIdx_x % 7 * 128 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 16 + threadIdx_y // 2 * 8 + threadIdx_x % 8] = A_reindex_shared_dyn_1[ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 128 + threadIdx_y * 32 + threadIdx_x]
