        ...
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(8, thread="blockIdx.x"):
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(64, thread="blockIdx.y"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(4, thread="threadIdx.y"):
                    for ax0_0_3_init, ax1_0_3_init, ax0_0_4_init, ax1_0_4_init in T.grid(4, 8, 1, 2):
                        with T.block("Y_o_init"):
                            v0_o = T.axis.spatial(256, ax0_0_1_ax1_0_1_fused // 2 * 8 + ax0_0_2_ax1_0_2_fused // 2 * 4 + ax0_0_3_init + ax0_0_4_init)
                            v1_o = T.axis.spatial(512, ax0_0_0_ax1_0_0_fused * 64 + ax0_0_1_ax1_0_1_fused % 2 * 32 + ax0_0_2_ax1_0_2_fused % 2 * 16 + ax1_0_3_init * 2 + ax1_0_4_init)
                            T.reads()
                    ...
                    for ax2_0_0 in T.serial(256, annotations={"software_pipeline_async_stages": [0], "software_pipeline_order": [0, 1, 3, 2, 4], "software_pipeline_stage": [0, 0, 1, 2, 2]}):
                        ...
                        with T.block("B_reindex_shared.dyn"):
                            ...
                            T.reads(B[v0 * 16:v0 * 16 + 16, v1 * 512 + v2 % 2 * 256:v1 * 512 + v2 % 2 * 256 + 256])
                            T.writes(B_reindex_shared_dyn[v0 * 16:v0 * 16 + 16, v1 * 512 + v2 % 2 * 256:v1 * 512 + v2 % 2 * 256 + 256])
                            T.block_attr({"auto_copy": 1, "buffer_dim_align": [[0, 0, 32, 8]], "permuted_layout": "g2s_B", "vector_bytes": 16})
                            for ax0, ax1 in T.grid(16, 256):
                                B_reindex_shared_dyn[v0 * 16 + ax0, v1 * 512 + v2 % 2 * 256 + ax1] = B[v0 * 16 + ax0, v1 * 512 + v2 % 2 * 256 + ax1]
                        for ax2_0_1 in T.serial(2, annotations={"software_pipeline_order": [0, 1, 2], "software_pipeline_stage": [0, 0, 1]}):
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.block("A_reindex_shared.dyn_m16n8k8.matrixA_o"):
                                    v0_o = T.axis.spatial(128, ax0_0_1_ax1_0_1_fused // 2 * 4 + ax0_0_2_ax1_0_2_fused // 2 * 2 + ax0_0)
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 4):
                                with T.block("B_reindex_shared.dyn_m16n8k8.matrixB_o"):
                                    ...
                                    v1_o = T.axis.spatial(128, ax0_0_0_ax1_0_0_fused * 16 + ax0_0_1_ax1_0_1_fused % 2 * 8 + ax0_0_2_ax1_0_2_fused % 2 * 4 + ax1_0)
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(4, 8, 1, 1, 2):
                                with T.block("Y_o_update"):
                                    v0_o = T.axis.spatial(256, ax0_0_1_ax1_0_1_fused // 2 * 8 + ax0_0_2_ax1_0_2_fused // 2 * 4 + ax0_0_3 + ax0_0_4)
                                    v1_o = T.axis.spatial(512, ax0_0_0_ax1_0_0_fused * 64 + ax0_0_1_ax1_0_1_fused % 2 * 32 + ax0_0_2_ax1_0_2_fused % 2 * 16 + ax1_0_3 * 2 + ax1_0_4)
                    ...
                    with T.block("Y_reindex_m16n8k8.matrixC"):
                        ...
                        T.reads(Y_reindex_m16n8k8_matrixC[v0 // 2 * 128 + v1 // 2 * 64:v0 // 2 * 128 + v1 // 2 * 64 + 64, v2 * 512 + v0 % 2 * 256 + v1 % 2 * 128:v2 * 512 + v0 % 2 * 256 + v1 % 2 * 128 + 128])
                        T.writes(Y[v0 // 2 * 128 + v1 // 2 * 64:v0 // 2 * 128 + v1 // 2 * 64 + 64, v2 * 512 + v0 % 2 * 256 + v1 % 2 * 128:v2 * 512 + v0 % 2 * 256 + v1 % 2 * 128 + 128])
                        T.block_attr({"auto_copy": 1})
                        for ax0, ax1 in T.grid(64, 128):
                            Y[v0 // 2 * 128 + v1 // 2 * 64 + ax0, v2 * 512 + v0 % 2 * 256 + v1 % 2 * 128 + ax1] = Y_reindex_m16n8k8_matrixC[v0 // 2 * 128 + v1 // 2 * 64 + ax0, v2 * 512 + v0 % 2 * 256 + v1 % 2 * 128 + ax1]
