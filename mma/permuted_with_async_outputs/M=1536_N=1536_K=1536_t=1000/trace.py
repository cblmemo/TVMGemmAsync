...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v23, v24, v25, v26, v27 = sch.sample_partitioned_tile(loop=l20, n=5, partition_pos=3, innerpart_factor=2, decision=[4, 4, 1, 6, 1])
  l28, l29, l30, l31, l32 = sch.split(loop=l20, factors=[v23, v24, v25, v26, v27], preserve_unit_iters=True)
  v33, v34, v35, v36, v37 = sch.sample_partitioned_tile(loop=l21, n=5, partition_pos=3, innerpart_factor=4, decision=[1, 12, 4, 4, 1])
  l38, l39, l40, l41, l42 = sch.split(loop=l21, factors=[v33, v34, v35, v36, v37], preserve_unit_iters=True)
  v43, v44, v45 = sch.sample_perfect_tile(loop=l22, n=3, max_innermost_factor=4, decision=[48, 4, 1])
