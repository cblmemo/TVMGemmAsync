...
class Module:
    ...
    def main(A: T.Buffer((1152, 1152), "float16"), B: T.Buffer((1152, 1152), "float16"), Y: T.Buffer((1152, 1152), "float16")):
        ...
        for ax0_0_3_init, ax0_0_4_init, ax1_0_4_init, b in T.grid(3, 2, 4, 2):
        ...
        with T.decl_buffer((9216,), "float16", data=A_reindex_shared_dyn, scope="shared.dyn") as A_reindex_shared_dyn_1:
            ...
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(3):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 8] = A_1[blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_ax1_fused_0 * 36864 + threadIdx_y * 9216 + threadIdx_x // 4 * 1152 + threadIdx_x % 4 * 8:blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_ax1_fused_0 * 36864 + threadIdx_y * 9216 + threadIdx_x // 4 * 1152 + threadIdx_x % 4 * 8 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(4):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 8] = B_1[ax0_ax1_fused_0 * 9216 + threadIdx_y * 2304 + threadIdx_x // 16 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + threadIdx_x % 16 * 8:ax0_ax1_fused_0 * 9216 + threadIdx_y * 2304 + threadIdx_x // 16 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + threadIdx_x % 16 * 8 + 8]
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    for ax0_ax1_fused_0 in range(3):
                        A_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 3072:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 3072 + 8] = A_1[blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_ax1_fused_0 * 36864 + threadIdx_y * 9216 + threadIdx_x // 4 * 1152 + threadIdx_x % 4 * 8 + 32:blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_ax1_fused_0 * 36864 + threadIdx_y * 9216 + threadIdx_x // 4 * 1152 + threadIdx_x % 4 * 8 + 32 + 8]
                T.attr(0, "async_scope", 1)
                for ax0_ax1_fused_0 in range(4):
                    B_reindex_shared_dyn_2[ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 4096:ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 4096 + 8] = B_1[ax0_ax1_fused_0 * 9216 + threadIdx_y * 2304 + threadIdx_x // 16 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + threadIdx_x % 16 * 8 + 36864:ax0_ax1_fused_0 * 9216 + threadIdx_y * 2304 + threadIdx_x // 16 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + threadIdx_x % 16 * 8 + 36864 + 8]
            ...
            for ax2_0_0 in range(34):
                with T.attr(0, "async_commit_queue_scope", 0):
                    with T.attr(0, "async_scope", 1):
                        for ax0_ax1_fused_0 in range(3):
                            A_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 3072 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8:(ax2_0_0 + 2) % 3 * 3072 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 4 * 32 + T.bitwise_xor(threadIdx_x % 4, threadIdx_x // 8) * 8 + 8] = A_1[blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_ax1_fused_0 * 36864 + threadIdx_y * 9216 + threadIdx_x // 4 * 1152 + ax2_0_0 * 32 + threadIdx_x % 4 * 8 + 64:blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_ax1_fused_0 * 36864 + threadIdx_y * 9216 + threadIdx_x // 4 * 1152 + ax2_0_0 * 32 + threadIdx_x % 4 * 8 + 64 + 8]
                    T.attr(0, "async_scope", 1)
                    for ax0_ax1_fused_0 in range(4):
                        B_reindex_shared_dyn_2[(ax2_0_0 + 2) % 3 * 4096 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8:(ax2_0_0 + 2) % 3 * 4096 + ax0_ax1_fused_0 * 1024 + threadIdx_y * 256 + threadIdx_x // 8 * 64 + T.bitwise_xor(threadIdx_x % 8, threadIdx_y * 2 + threadIdx_x // 16) * 8 + 8] = B_1[ax2_0_0 * 36864 + ax0_ax1_fused_0 * 9216 + threadIdx_y * 2304 + threadIdx_x // 16 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + threadIdx_x % 16 * 8 + 73728:ax2_0_0 * 36864 + ax0_ax1_fused_0 * 9216 + threadIdx_y * 2304 + threadIdx_x // 16 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + threadIdx_x % 16 * 8 + 73728 + 8]
                with T.attr(0, "async_wait_queue_scope", 0):
                    T.attr(0, "async_wait_inflight_count", 1)
                    for ax2_0_1 in range(3):
                        ...
                        for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(3, 2, 4):
            ...
            for ax2_0_1 in range(3):
                ...
                for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(3, 2, 4):
                    ...
                    T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, cse_var_11 * 24 + ax0_0_3 * 8 + ax0_0_4 * 4, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_11 * 8 + cse_var_10, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_10, T.bool(False))
            for ax0_0_3, ax0_0_4, ax1_0_4 in T.grid(3, 2, 4):
                cse_var_12: T.int32 = ax1_0_4 * 2
                T.ptx_mma("float16", "m16n8k8", "row", "col", "fp16", "fp16", "fp16", A_reindex_shared_dyn_m16n8k8_matrixA, ax0_0_3 * 8 + ax0_0_4 * 4 + 24, B_reindex_shared_dyn_m16n8k8_matrixB, cse_var_12 + 8, Y_reindex_m16n8k8_matrixC, ax0_0_3 * 16 + ax0_0_4 * 8 + cse_var_12, T.bool(False))
        ...
        for ax0_0 in range(12):
            ...
            for ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 in range(8):
                ...
                Y_1[blockIdx_x // 3 * 442368 + blockIdx_y // 3 * 110592 + ax0_0 * 9216 + threadIdx_y % 2 * 4608 + threadIdx_x // 8 * 1152 + blockIdx_x % 3 * 384 + blockIdx_y % 3 * 128 + ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 16 + threadIdx_y // 2 * 8 + threadIdx_x % 8] = A_reindex_shared_dyn_1[ax0_0_2_ax1_0_2_fused_cache_ax1_0_cache_ax0_1_cache_ax1_1_cache_fused_0 * 128 + threadIdx_y * 32 + threadIdx_x]
