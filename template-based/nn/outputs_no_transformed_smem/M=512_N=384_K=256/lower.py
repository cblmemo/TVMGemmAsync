    ...
    def main(A: T.Buffer[(512, 256), "float32"], B: T.Buffer[(256, 384), "float32"], Y: T.Buffer[(512, 384), "float32"]):
        ...
        with T.attr(0, "async_commit_queue_scope", 0):
            with T.attr(0, "async_scope", 1):
                A_shared_dyn_1[threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2:threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 2] = A_1[blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2:blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 2]
        ...
        with T.attr(0, "async_commit_queue_scope", 0):
            with T.attr(0, "async_scope", 1):
                A_shared_dyn_1[threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 640:threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 640 + 2] = A_1[blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 8:blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 8 + 2]
            T.attr(0, "async_scope", 1)
        ...
        with T.attr(0, "async_commit_queue_scope", 0):
            with T.attr(0, "async_scope", 1):
                A_shared_dyn_1[threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 1280:threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 1280 + 2] = A_1[blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 16:blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 16 + 2]
            T.attr(0, "async_scope", 1)
        ...
        with T.attr(0, "async_commit_queue_scope", 0):
            with T.attr(0, "async_scope", 1):
                A_shared_dyn_1[threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 1920:threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 1920 + 2] = A_1[blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 24:blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + threadIdx_x % 4 * 2 + 24 + 2]
            T.attr(0, "async_scope", 1)
        ...
        for k_0 in T.serial(28):
            ...
            with T.attr(0, "async_commit_queue_scope", 0):
                with T.attr(0, "async_scope", 1):
                    A_shared_dyn_1[cse_var_1 * 640 + threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2:cse_var_1 * 640 + threadIdx_x // 4 * 20 + threadIdx_x % 4 // 2 * 16 + threadIdx_x % 2 * 2 + 2] = A_1[blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + k_0 * 8 + threadIdx_x % 4 * 2 + 32:blockIdx_x // 6 * 8192 + threadIdx_x // 4 * 256 + k_0 * 8 + threadIdx_x % 4 * 2 + 32 + 2]
                T.attr(0, "async_scope", 1)
                B_shared_dyn_1[cse_var_1 * 512 + threadIdx_x // 16 * 64 + threadIdx_x % 2 * 32 + threadIdx_x % 16 // 2 * 4:cse_var_1 * 512 + threadIdx_x // 16 * 64 + threadIdx_x % 2 * 32 + threadIdx_x % 16 // 2 * 4 + 4] = B_1[k_0 * 3072 + threadIdx_x // 16 * 384 + blockIdx_x % 6 * 64 + threadIdx_x % 16 * 4 + 12288:k_0 * 3072 + threadIdx_x // 16 * 384 + blockIdx_x % 6 * 64 + threadIdx_x % 16 * 4 + 12288 + 4]
            with T.attr(0, "async_wait_queue_scope", 0):
                T.attr(0, "async_wait_inflight_count", 3)
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1]
                for ax1_0 in T.serial(2):
                ...
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 2]
                for ax1_0 in T.serial(2):
                ...
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 3]
                for ax1_0 in T.serial(2):
                ...
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 16]
                for ax1_0 in T.serial(2):
                ...
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 17]
                for ax1_0 in T.serial(2):
                ...
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 18]
                for ax1_0 in T.serial(2):
                ...
                for ax0_1_s in T.serial(4):
                    if ax0_1_s < 2:
                        A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[k_0 % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 19]
                for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[(k_0 + 1) % 5 * 640 + threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20]
            for ax1_0 in T.serial(2):
        ...
        with T.attr(0, "async_wait_queue_scope", 0):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1921]
            for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1922]
            for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1923]
            for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1936]
            for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1937]
            for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1938]
            for ax1_0 in T.serial(2):
            ...
            for ax0_1_s in T.serial(4):
                if ax0_1_s < 2:
                    A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 1939]
            for ax1_0 in T.serial(2):
        ...
        for ax1_0 in T.serial(2):
            B_shared_dyn_local_1[ax1_0 * 4:ax1_0 * 4 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2048:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2048 + 4]
        for i_2_1_s in T.serial(4):
            if i_2_1_s < 2:
        ...
        with T.attr(0, "async_wait_queue_scope", 0):
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4 + 8:ax1_0 * 4 + 8 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2112:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2112 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4:ax1_0 * 4 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2176:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2176 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4 + 8:ax1_0 * 4 + 8 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2240:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2240 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4:ax1_0 * 4 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2304:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2304 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4 + 8:ax1_0 * 4 + 8 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2368:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2368 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4:ax1_0 * 4 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2432:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2432 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
            ...
            for ax1_0 in T.serial(2):
                B_shared_dyn_local_1[ax1_0 * 4 + 8:ax1_0 * 4 + 8 + 4] = B_shared_dyn_1[ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2496:ax1_0 * 32 + threadIdx_x % 16 // 2 * 4 + 2496 + 4]
            for i_2_1_s in T.serial(4):
                if i_2_1_s < 2:
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 640]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 641]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 642]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 643]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 656]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 657]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 658]
        for ax1_0 in T.serial(2):
        ...
        for ax0_1_s in T.serial(4):
            if ax0_1_s < 2:
                A_shared_dyn_local_1[ax0_1_s + 2] = A_shared_dyn_1[threadIdx_x // 16 * 80 + threadIdx_x % 2 * 40 + ax0_1_s * 20 + 659]
        for ax1_0 in T.serial(2):
        ...
        for ax1_0 in T.serial(2):
            ...
            Y_1[blockIdx_x // 6 * 12288 + threadIdx_x // 16 * 1536 + threadIdx_x % 2 * 768 + blockIdx_x % 6 * 64 + threadIdx_x % 16 // 2 * 8 + cse_var_322:blockIdx_x // 6 * 12288 + threadIdx_x // 16 * 1536 + threadIdx_x % 2 * 768 + blockIdx_x % 6 * 64 + threadIdx_x % 16 // 2 * 8 + cse_var_322 + 4] = Y_local_1[cse_var_322:cse_var_322 + 4]
        for ax1_0 in T.serial(2):
            cse_var_323: T.int32 = ax1_0 * 4
            Y_1[blockIdx_x // 6 * 12288 + threadIdx_x // 16 * 1536 + threadIdx_x % 2 * 768 + blockIdx_x % 6 * 64 + threadIdx_x % 16 // 2 * 8 + cse_var_323 + 384:blockIdx_x // 6 * 12288 + threadIdx_x // 16 * 1536 + threadIdx_x % 2 * 768 + blockIdx_x % 6 * 64 + threadIdx_x % 16 // 2 * 8 + cse_var_323 + 384 + 4] = Y_local_1[cse_var_323 + 8:cse_var_323 + 8 + 4]
