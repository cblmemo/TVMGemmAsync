...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)blockIdx.x) / 6) * 8192) + ((((int)threadIdx.x) >> 2) * 256)) + ((((int)threadIdx.x) & 3) * 2)))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((int)threadIdx.x) >> 4) * 384) + ((((int)blockIdx.x) % 6) * 64)) + ((((int)threadIdx.x) & 15) * 4)))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) / 6) * 8192) + ((((int)threadIdx.x) >> 2) * 256)) + ((((int)threadIdx.x) & 3) * 2)) + 8))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 4) * 384) + ((((int)blockIdx.x) % 6) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 3072))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) / 6) * 8192) + ((((int)threadIdx.x) >> 2) * 256)) + ((((int)threadIdx.x) & 3) * 2)) + 16))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 4) * 384) + ((((int)blockIdx.x) % 6) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 6144))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) / 6) * 8192) + ((((int)threadIdx.x) >> 2) * 256)) + ((((int)threadIdx.x) & 3) * 2)) + 24))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 4) * 384) + ((((int)blockIdx.x) % 6) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 9216))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) / 6) * 8192) + ((((int)threadIdx.x) >> 2) * 256)) + (k_0 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 32))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((k_0 * 3072) + ((((int)threadIdx.x) >> 4) * 384)) + ((((int)blockIdx.x) % 6) * 64)) + ((((int)threadIdx.x) & 15) * 4)) + 12288))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
    ...
    for (int ax0_1_s_1 = 0; ax0_1_s_1 < 4; ++ax0_1_s_1) {
      if (ax0_1_s_1 < 2) {
        A_shared_dyn_local[(ax0_1_s_1 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_1 * 20)) + 2561)];
      }
    }
    ...
    for (int ax0_1_s_2 = 0; ax0_1_s_2 < 4; ++ax0_1_s_2) {
      if (ax0_1_s_2 < 2) {
        A_shared_dyn_local[ax0_1_s_2] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_2 * 20)) + 2562)];
      }
    }
    ...
    for (int ax0_1_s_3 = 0; ax0_1_s_3 < 4; ++ax0_1_s_3) {
      if (ax0_1_s_3 < 2) {
        A_shared_dyn_local[(ax0_1_s_3 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_3 * 20)) + 2563)];
      }
    }
    ...
    for (int ax0_1_s_4 = 0; ax0_1_s_4 < 4; ++ax0_1_s_4) {
      if (ax0_1_s_4 < 2) {
        A_shared_dyn_local[ax0_1_s_4] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_4 * 20)) + 2576)];
      }
    }
    ...
    for (int ax0_1_s_5 = 0; ax0_1_s_5 < 4; ++ax0_1_s_5) {
      if (ax0_1_s_5 < 2) {
        A_shared_dyn_local[(ax0_1_s_5 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_5 * 20)) + 2577)];
      }
    }
    ...
    for (int ax0_1_s_6 = 0; ax0_1_s_6 < 4; ++ax0_1_s_6) {
      if (ax0_1_s_6 < 2) {
        A_shared_dyn_local[ax0_1_s_6] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_6 * 20)) + 2578)];
      }
    }
    ...
    for (int ax0_1_s_7 = 0; ax0_1_s_7 < 4; ++ax0_1_s_7) {
      if (ax0_1_s_7 < 2) {
        A_shared_dyn_local[(ax0_1_s_7 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_7 * 20)) + 2579)];
      }
    }
    ...
    for (int ax0_1_s_8 = 0; ax0_1_s_8 < 4; ++ax0_1_s_8) {
      if (ax0_1_s_8 < 2) {
        A_shared_dyn_local[ax0_1_s_8] = ((float*)buf_dyn_shmem)[(((((((k_0 + 1) % 5) * 640) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_8 * 20)) + 2560)];
      }
    }
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  for (int ax0_1_s_9 = 0; ax0_1_s_9 < 4; ++ax0_1_s_9) {
    if (ax0_1_s_9 < 2) {
      A_shared_dyn_local[(ax0_1_s_9 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_9 * 20)) + 4481)];
    }
  }
  for (int ax1_0_9 = 0; ax1_0_9 < 2; ++ax1_0_9) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_9 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_9 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1600));
  }
  ...
  for (int ax0_1_s_10 = 0; ax0_1_s_10 < 4; ++ax0_1_s_10) {
    if (ax0_1_s_10 < 2) {
      A_shared_dyn_local[ax0_1_s_10] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_10 * 20)) + 4482)];
    }
  }
  for (int ax1_0_10 = 0; ax1_0_10 < 2; ++ax1_0_10) {
    *(float4*)(B_shared_dyn_local + (ax1_0_10 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_10 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1664));
  }
  ...
  for (int ax0_1_s_11 = 0; ax0_1_s_11 < 4; ++ax0_1_s_11) {
    if (ax0_1_s_11 < 2) {
      A_shared_dyn_local[(ax0_1_s_11 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_11 * 20)) + 4483)];
    }
  }
  for (int ax1_0_11 = 0; ax1_0_11 < 2; ++ax1_0_11) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_11 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_11 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1728));
  }
  ...
  for (int ax0_1_s_12 = 0; ax0_1_s_12 < 4; ++ax0_1_s_12) {
    if (ax0_1_s_12 < 2) {
      A_shared_dyn_local[ax0_1_s_12] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_12 * 20)) + 4496)];
    }
  }
  for (int ax1_0_12 = 0; ax1_0_12 < 2; ++ax1_0_12) {
    *(float4*)(B_shared_dyn_local + (ax1_0_12 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_12 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1792));
  }
  ...
  for (int ax0_1_s_13 = 0; ax0_1_s_13 < 4; ++ax0_1_s_13) {
    if (ax0_1_s_13 < 2) {
      A_shared_dyn_local[(ax0_1_s_13 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_13 * 20)) + 4497)];
    }
  }
  for (int ax1_0_13 = 0; ax1_0_13 < 2; ++ax1_0_13) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_13 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_13 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1856));
  }
  ...
  for (int ax0_1_s_14 = 0; ax0_1_s_14 < 4; ++ax0_1_s_14) {
    if (ax0_1_s_14 < 2) {
      A_shared_dyn_local[ax0_1_s_14] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_14 * 20)) + 4498)];
    }
  }
  for (int ax1_0_14 = 0; ax1_0_14 < 2; ++ax1_0_14) {
    *(float4*)(B_shared_dyn_local + (ax1_0_14 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_14 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1920));
  }
  ...
  for (int ax0_1_s_15 = 0; ax0_1_s_15 < 4; ++ax0_1_s_15) {
    if (ax0_1_s_15 < 2) {
      A_shared_dyn_local[(ax0_1_s_15 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_15 * 20)) + 4499)];
    }
  }
  for (int ax1_0_15 = 0; ax1_0_15 < 2; ++ax1_0_15) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_15 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_15 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1984));
  }
  ...
  for (int ax0_1_s_16 = 0; ax0_1_s_16 < 4; ++ax0_1_s_16) {
    if (ax0_1_s_16 < 2) {
      A_shared_dyn_local[ax0_1_s_16] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_16 * 20)) + 5120)];
    }
  }
  for (int ax1_0_16 = 0; ax1_0_16 < 2; ++ax1_0_16) {
    *(float4*)(B_shared_dyn_local + (ax1_0_16 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_16 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2048));
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  for (int ax0_1_s_17 = 0; ax0_1_s_17 < 4; ++ax0_1_s_17) {
    if (ax0_1_s_17 < 2) {
      A_shared_dyn_local[(ax0_1_s_17 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_17 * 20)) + 5121)];
    }
  }
  for (int ax1_0_17 = 0; ax1_0_17 < 2; ++ax1_0_17) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_17 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_17 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2112));
  }
  ...
  for (int ax0_1_s_18 = 0; ax0_1_s_18 < 4; ++ax0_1_s_18) {
    if (ax0_1_s_18 < 2) {
      A_shared_dyn_local[ax0_1_s_18] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_18 * 20)) + 5122)];
    }
  }
  for (int ax1_0_18 = 0; ax1_0_18 < 2; ++ax1_0_18) {
    *(float4*)(B_shared_dyn_local + (ax1_0_18 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_18 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2176));
  }
  ...
  for (int ax0_1_s_19 = 0; ax0_1_s_19 < 4; ++ax0_1_s_19) {
    if (ax0_1_s_19 < 2) {
      A_shared_dyn_local[(ax0_1_s_19 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_19 * 20)) + 5123)];
    }
  }
  for (int ax1_0_19 = 0; ax1_0_19 < 2; ++ax1_0_19) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_19 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_19 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2240));
  }
  ...
  for (int ax0_1_s_20 = 0; ax0_1_s_20 < 4; ++ax0_1_s_20) {
    if (ax0_1_s_20 < 2) {
      A_shared_dyn_local[ax0_1_s_20] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_20 * 20)) + 5136)];
    }
  }
  for (int ax1_0_20 = 0; ax1_0_20 < 2; ++ax1_0_20) {
    *(float4*)(B_shared_dyn_local + (ax1_0_20 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_20 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2304));
  }
  ...
  for (int ax0_1_s_21 = 0; ax0_1_s_21 < 4; ++ax0_1_s_21) {
    if (ax0_1_s_21 < 2) {
      A_shared_dyn_local[(ax0_1_s_21 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_21 * 20)) + 5137)];
    }
  }
  for (int ax1_0_21 = 0; ax1_0_21 < 2; ++ax1_0_21) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_21 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_21 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2368));
  }
  ...
  for (int ax0_1_s_22 = 0; ax0_1_s_22 < 4; ++ax0_1_s_22) {
    if (ax0_1_s_22 < 2) {
      A_shared_dyn_local[ax0_1_s_22] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_22 * 20)) + 5138)];
    }
  }
  for (int ax1_0_22 = 0; ax1_0_22 < 2; ++ax1_0_22) {
    *(float4*)(B_shared_dyn_local + (ax1_0_22 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_22 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2432));
  }
  ...
  for (int ax0_1_s_23 = 0; ax0_1_s_23 < 4; ++ax0_1_s_23) {
    if (ax0_1_s_23 < 2) {
      A_shared_dyn_local[(ax0_1_s_23 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_23 * 20)) + 5139)];
    }
  }
  for (int ax1_0_23 = 0; ax1_0_23 < 2; ++ax1_0_23) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_23 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_23 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2496));
  }
  ...
  for (int ax0_1_s_24 = 0; ax0_1_s_24 < 4; ++ax0_1_s_24) {
    if (ax0_1_s_24 < 2) {
      A_shared_dyn_local[ax0_1_s_24] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_24 * 20)) + 2560)];
    }
  }
  for (int ax1_0_24 = 0; ax1_0_24 < 2; ++ax1_0_24) {
    *(float4*)(B_shared_dyn_local + (ax1_0_24 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((ax1_0_24 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)));
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  for (int ax0_1_s_25 = 0; ax0_1_s_25 < 4; ++ax0_1_s_25) {
    if (ax0_1_s_25 < 2) {
      A_shared_dyn_local[(ax0_1_s_25 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_25 * 20)) + 2561)];
    }
  }
  for (int ax1_0_25 = 0; ax1_0_25 < 2; ++ax1_0_25) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_25 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_25 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 64));
  }
  ...
  for (int ax0_1_s_26 = 0; ax0_1_s_26 < 4; ++ax0_1_s_26) {
    if (ax0_1_s_26 < 2) {
      A_shared_dyn_local[ax0_1_s_26] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_26 * 20)) + 2562)];
    }
  }
  for (int ax1_0_26 = 0; ax1_0_26 < 2; ++ax1_0_26) {
    *(float4*)(B_shared_dyn_local + (ax1_0_26 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_26 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 128));
  }
  ...
  for (int ax0_1_s_27 = 0; ax0_1_s_27 < 4; ++ax0_1_s_27) {
    if (ax0_1_s_27 < 2) {
      A_shared_dyn_local[(ax0_1_s_27 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_27 * 20)) + 2563)];
    }
  }
  for (int ax1_0_27 = 0; ax1_0_27 < 2; ++ax1_0_27) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_27 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_27 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 192));
  }
  ...
  for (int ax0_1_s_28 = 0; ax0_1_s_28 < 4; ++ax0_1_s_28) {
    if (ax0_1_s_28 < 2) {
      A_shared_dyn_local[ax0_1_s_28] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_28 * 20)) + 2576)];
    }
  }
  for (int ax1_0_28 = 0; ax1_0_28 < 2; ++ax1_0_28) {
    *(float4*)(B_shared_dyn_local + (ax1_0_28 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_28 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 256));
  }
  ...
  for (int ax0_1_s_29 = 0; ax0_1_s_29 < 4; ++ax0_1_s_29) {
    if (ax0_1_s_29 < 2) {
      A_shared_dyn_local[(ax0_1_s_29 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_29 * 20)) + 2577)];
    }
  }
  for (int ax1_0_29 = 0; ax1_0_29 < 2; ++ax1_0_29) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_29 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_29 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 320));
  }
  ...
  for (int ax0_1_s_30 = 0; ax0_1_s_30 < 4; ++ax0_1_s_30) {
    if (ax0_1_s_30 < 2) {
      A_shared_dyn_local[ax0_1_s_30] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_30 * 20)) + 2578)];
    }
  }
  for (int ax1_0_30 = 0; ax1_0_30 < 2; ++ax1_0_30) {
    *(float4*)(B_shared_dyn_local + (ax1_0_30 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_30 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 384));
  }
  ...
  for (int ax0_1_s_31 = 0; ax0_1_s_31 < 4; ++ax0_1_s_31) {
    if (ax0_1_s_31 < 2) {
      A_shared_dyn_local[(ax0_1_s_31 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_31 * 20)) + 2579)];
    }
  }
  for (int ax1_0_31 = 0; ax1_0_31 < 2; ++ax1_0_31) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_31 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_31 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 448));
  }
  ...
  for (int ax0_1_s_32 = 0; ax0_1_s_32 < 4; ++ax0_1_s_32) {
    if (ax0_1_s_32 < 2) {
      A_shared_dyn_local[ax0_1_s_32] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_32 * 20)) + 3200)];
    }
  }
  for (int ax1_0_32 = 0; ax1_0_32 < 2; ++ax1_0_32) {
    *(float4*)(B_shared_dyn_local + (ax1_0_32 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_32 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 512));
  }
  ...
  for (int ax0_1_s_33 = 0; ax0_1_s_33 < 4; ++ax0_1_s_33) {
    if (ax0_1_s_33 < 2) {
      A_shared_dyn_local[(ax0_1_s_33 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_33 * 20)) + 3201)];
    }
  }
  for (int ax1_0_33 = 0; ax1_0_33 < 2; ++ax1_0_33) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_33 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_33 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 576));
  }
  ...
  for (int ax0_1_s_34 = 0; ax0_1_s_34 < 4; ++ax0_1_s_34) {
    if (ax0_1_s_34 < 2) {
      A_shared_dyn_local[ax0_1_s_34] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_34 * 20)) + 3202)];
    }
  }
  for (int ax1_0_34 = 0; ax1_0_34 < 2; ++ax1_0_34) {
    *(float4*)(B_shared_dyn_local + (ax1_0_34 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_34 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 640));
  }
  ...
  for (int ax0_1_s_35 = 0; ax0_1_s_35 < 4; ++ax0_1_s_35) {
    if (ax0_1_s_35 < 2) {
      A_shared_dyn_local[(ax0_1_s_35 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_35 * 20)) + 3203)];
    }
  }
  for (int ax1_0_35 = 0; ax1_0_35 < 2; ++ax1_0_35) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_35 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_35 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 704));
  }
  ...
  for (int ax0_1_s_36 = 0; ax0_1_s_36 < 4; ++ax0_1_s_36) {
    if (ax0_1_s_36 < 2) {
      A_shared_dyn_local[ax0_1_s_36] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_36 * 20)) + 3216)];
    }
  }
  for (int ax1_0_36 = 0; ax1_0_36 < 2; ++ax1_0_36) {
    *(float4*)(B_shared_dyn_local + (ax1_0_36 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_36 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 768));
  }
  ...
  for (int ax0_1_s_37 = 0; ax0_1_s_37 < 4; ++ax0_1_s_37) {
    if (ax0_1_s_37 < 2) {
      A_shared_dyn_local[(ax0_1_s_37 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_37 * 20)) + 3217)];
    }
  }
  for (int ax1_0_37 = 0; ax1_0_37 < 2; ++ax1_0_37) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_37 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_37 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 832));
  }
  ...
  for (int ax0_1_s_38 = 0; ax0_1_s_38 < 4; ++ax0_1_s_38) {
    if (ax0_1_s_38 < 2) {
      A_shared_dyn_local[ax0_1_s_38] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_38 * 20)) + 3218)];
    }
  }
  for (int ax1_0_38 = 0; ax1_0_38 < 2; ++ax1_0_38) {
    *(float4*)(B_shared_dyn_local + (ax1_0_38 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_38 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 896));
  }
  ...
  for (int ax0_1_s_39 = 0; ax0_1_s_39 < 4; ++ax0_1_s_39) {
    if (ax0_1_s_39 < 2) {
      A_shared_dyn_local[(ax0_1_s_39 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_39 * 20)) + 3219)];
    }
  }
  for (int ax1_0_39 = 0; ax1_0_39 < 2; ++ax1_0_39) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_39 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((ax1_0_39 * 32) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 960));
  }
  ...
  for (int ax1_0_40 = 0; ax1_0_40 < 2; ++ax1_0_40) {
    *(float4*)(Y + (((((((((int)blockIdx.x) / 6) * 12288) + ((((int)threadIdx.x) >> 4) * 1536)) + ((((int)threadIdx.x) & 1) * 768)) + ((((int)blockIdx.x) % 6) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + (ax1_0_40 * 4))) = *(float4*)(Y_local + (ax1_0_40 * 4));
  }
  for (int ax1_0_41 = 0; ax1_0_41 < 2; ++ax1_0_41) {
    *(float4*)(Y + ((((((((((int)blockIdx.x) / 6) * 12288) + ((((int)threadIdx.x) >> 4) * 1536)) + ((((int)threadIdx.x) & 1) * 768)) + ((((int)blockIdx.x) % 6) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + (ax1_0_41 * 4)) + 384)) = *(float4*)(Y_local + ((ax1_0_41 * 4) + 8));
  }
}
