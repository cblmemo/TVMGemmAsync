...
extern "C" __global__ void __launch_bounds__(128) main_kernel0(float* __restrict__ A, float* __restrict__ B, float* __restrict__ Y) {
...

  {
    ...
    __asm__ __volatile__(
      ...
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((int)threadIdx.x) & 3) * 128) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((((int)threadIdx.x) & 15) >> 2) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 2) * 896)) + (((int)threadIdx.x) & 3)))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((int)threadIdx.x) >> 5) * 896) + ((((int)blockIdx.x) % 7) * 128)) + ((((int)threadIdx.x) & 31) * 4)))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) & 3) * 128) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((((int)threadIdx.x) & 15) >> 2) * 4)) + 512)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 2) * 896)) + (((int)threadIdx.x) & 3)) + 4))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 896) + ((((int)blockIdx.x) % 7) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 3584))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) & 3) * 128) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((((int)threadIdx.x) & 15) >> 2) * 4)) + 1024)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 2) * 896)) + (((int)threadIdx.x) & 3)) + 8))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 896) + ((((int)blockIdx.x) % 7) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 7168))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) & 3) * 128) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((((int)threadIdx.x) & 15) >> 2) * 4)) + 1536)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 2) * 896)) + (((int)threadIdx.x) & 3)) + 12))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 896) + ((((int)blockIdx.x) % 7) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 10752))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
  ...
  __syncthreads();
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + (((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)));
  for (int ax1_0 = 0; ax1_0 < 2; ++ax1_0) {
    *(float4*)(B_shared_dyn_local + (ax1_0 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 640));
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((k_0 + 4) % 5) * 512) + ((((int)threadIdx.x) & 3) * 128)) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + ((((int)threadIdx.x) >> 5) * 16)) + (((((int)threadIdx.x) & 15) >> 2) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 2) * 896)) + (k_0 * 4)) + (((int)threadIdx.x) & 3)) + 16))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((k_0 * 3584) + ((((int)threadIdx.x) >> 5) * 896)) + ((((int)blockIdx.x) % 7) * 128)) + ((((int)threadIdx.x) & 31) * 4)) + 14336))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
    ...
    __syncthreads();
    A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + (((((k_0 % 5) * 128) + ((((int)threadIdx.x) & 1) * 16)) + ((((int)threadIdx.x) >> 5) * 4)) + 32));
    for (int ax1_0_1 = 0; ax1_0_1 < 2; ++ax1_0_1) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_1 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 512) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + (ax1_0_1 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 768));
    }
    ...
    A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + (((((k_0 % 5) * 128) + ((((int)threadIdx.x) & 1) * 16)) + ((((int)threadIdx.x) >> 5) * 4)) + 64));
    for (int ax1_0_2 = 0; ax1_0_2 < 2; ++ax1_0_2) {
      *(float4*)(B_shared_dyn_local + (ax1_0_2 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 512) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + (ax1_0_2 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 896));
    }
    ...
    A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + (((((k_0 % 5) * 128) + ((((int)threadIdx.x) & 1) * 16)) + ((((int)threadIdx.x) >> 5) * 4)) + 96));
    for (int ax1_0_3 = 0; ax1_0_3 < 2; ++ax1_0_3) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_3 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 512) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + (ax1_0_3 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1024));
    }
    ...
    A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + (((((k_0 + 1) % 5) * 128) + ((((int)threadIdx.x) & 1) * 16)) + ((((int)threadIdx.x) >> 5) * 4)));
    for (int ax1_0_4 = 0; ax1_0_4 < 2; ++ax1_0_4) {
      *(float4*)(B_shared_dyn_local + (ax1_0_4 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 + 1) % 5) * 512) + (((((int)threadIdx.x) & 31) >> 4) * 64)) + (ax1_0_4 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 640));
    }
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  __syncthreads();
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 32));
  for (int ax1_0_5 = 0; ax1_0_5 < 2; ++ax1_0_5) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_5 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_5 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 768));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 64));
  for (int ax1_0_6 = 0; ax1_0_6 < 2; ++ax1_0_6) {
    *(float4*)(B_shared_dyn_local + (ax1_0_6 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_6 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 896));
  }
  ...
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 96));
  for (int ax1_0_7 = 0; ax1_0_7 < 2; ++ax1_0_7) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_7 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_7 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1024));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 128));
  for (int ax1_0_8 = 0; ax1_0_8 < 2; ++ax1_0_8) {
    *(float4*)(B_shared_dyn_local + (ax1_0_8 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_8 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1152));
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  __syncthreads();
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 160));
  for (int ax1_0_9 = 0; ax1_0_9 < 2; ++ax1_0_9) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_9 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_9 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1280));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 192));
  for (int ax1_0_10 = 0; ax1_0_10 < 2; ++ax1_0_10) {
    *(float4*)(B_shared_dyn_local + (ax1_0_10 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_10 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1408));
  }
  ...
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 224));
  for (int ax1_0_11 = 0; ax1_0_11 < 2; ++ax1_0_11) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_11 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_11 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1536));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 256));
  for (int ax1_0_12 = 0; ax1_0_12 < 2; ++ax1_0_12) {
    *(float4*)(B_shared_dyn_local + (ax1_0_12 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_12 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1664));
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  __syncthreads();
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 288));
  for (int ax1_0_13 = 0; ax1_0_13 < 2; ++ax1_0_13) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_13 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_13 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1792));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 320));
  for (int ax1_0_14 = 0; ax1_0_14 < 2; ++ax1_0_14) {
    *(float4*)(B_shared_dyn_local + (ax1_0_14 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_14 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 1920));
  }
  ...
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 352));
  for (int ax1_0_15 = 0; ax1_0_15 < 2; ++ax1_0_15) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_15 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_15 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2048));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 384));
  for (int ax1_0_16 = 0; ax1_0_16 < 2; ++ax1_0_16) {
    *(float4*)(B_shared_dyn_local + (ax1_0_16 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_16 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2176));
  }
  ...
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 416));
  for (int ax1_0_17 = 0; ax1_0_17 < 2; ++ax1_0_17) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_17 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_17 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2304));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 448));
  for (int ax1_0_18 = 0; ax1_0_18 < 2; ++ax1_0_18) {
    *(float4*)(B_shared_dyn_local + (ax1_0_18 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_18 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2432));
  }
  ...
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((int)threadIdx.x) & 1) * 16) + ((((int)threadIdx.x) >> 5) * 4)) + 480));
  for (int ax1_0_19 = 0; ax1_0_19 < 2; ++ax1_0_19) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_19 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 31) >> 4) * 64) + (ax1_0_19 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2560));
  }
  ...
  *(float4*)(Y + ((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8))) = *(float4*)(Y_local + 0);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 4)) = *(float4*)(Y_local + 4);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 896)) = *(float4*)(Y_local + 8);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 900)) = *(float4*)(Y_local + 12);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 1792)) = *(float4*)(Y_local + 16);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 1796)) = *(float4*)(Y_local + 20);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 2688)) = *(float4*)(Y_local + 24);
  *(float4*)(Y + (((((((((int)blockIdx.x) / 7) * 28672) + ((((int)threadIdx.x) >> 5) * 7168)) + ((((int)threadIdx.x) & 1) * 3584)) + ((((int)blockIdx.x) % 7) * 128)) + (((((int)threadIdx.x) & 31) >> 1) * 8)) + 2692)) = *(float4*)(Y_local + 28);
}
