                ...
                for j_2_init in T.unroll(8):
                    for i_2_0_init in T.unroll(3):
                        for i_2_1_init in T.unroll(4):
                            with T.block("Y_init"):
                                v_i = T.axis.spatial(3072, i_0_j_0_fused // 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + i_2_0_init * 4 + i_2_1_init)
                                v_j = T.axis.spatial(3072, i_0_j_0_fused % 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + j_2_init)
                                T.reads()
                    ...
                    for ax0_0_ax1_fused in T.thread_binding(384, thread="threadIdx.x"):
                        for ax0_1 in T.unroll(3):
                            with T.block("A_shared.dyn"):
                                v0 = T.axis.spatial(3072, i_0_j_0_fused // 16 * 192 + ax0_0_ax1_fused // 6 * 3 + ax0_1)
                                v1 = T.axis.spatial(3072, k_0 * 6 + ax0_0_ax1_fused % 6)
                                T.reads(A[v0, v1])
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(384, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.vectorized(3):
                            with T.block("B_shared.dyn"):
                                v0 = T.axis.spatial(3072, k_0 * 6 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 24 * 72 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 24 * 3 + ax0_ax1_fused_2) // 192)
                                v1 = T.axis.spatial(3072, i_0_j_0_fused % 16 * 192 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 24 * 72 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 24 * 3 + ax0_ax1_fused_2) % 192)
                                T.reads(B[v0, v1])
                            ...
                            for ax0_1 in T.vectorized(4):
                                for ax1 in T.serial(1):
                                    with T.block("A_shared.dyn_local"):
                                        v0 = T.axis.spatial(3072, i_0_j_0_fused // 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + ax0_0 * 4 + ax0_1)
                                        v1 = T.axis.spatial(3072, ax1 + k_0 * 6 + k_1)
                        ...
                        for ax0, ax1_0 in T.grid(1, 2):
                            for ax1_1 in T.vectorized(4):
                                with T.block("B_shared.dyn_local"):
                                    v0 = T.axis.spatial(3072, ax0 + k_0 * 6 + k_1)
                                    v1 = T.axis.spatial(3072, i_0_j_0_fused % 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + ax1_0 * 4 + ax1_1)
                            ...
                            for i_2_0 in T.unroll(3):
                                for i_2_1 in T.vectorized(4):
                                    with T.block("Y_update"):
                                        v_i = T.axis.spatial(3072, i_0_j_0_fused // 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + i_2_0 * 4 + i_2_1)
                                        v_j = T.axis.spatial(3072, i_0_j_0_fused % 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + j_2)
                                        v_k = T.axis.reduce(3072, k_0 * 6 + k_1)
                    ...
                    for ax1_0 in T.unroll(2):
                        for ax1_1 in T.vectorized(4):
                            with T.block("Y_local"):
                                v0 = T.axis.spatial(3072, i_0_j_0_fused // 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + ax0)
                                v1 = T.axis.spatial(3072, i_0_j_0_fused % 16 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + ax1_0 * 4 + ax1_1)
