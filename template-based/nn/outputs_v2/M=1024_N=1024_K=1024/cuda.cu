...
extern "C" __global__ void __launch_bounds__(256) main_kernel0(float* __restrict__ A, float* __restrict__ B, float* __restrict__ Y) {
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 1024))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 5) * 256) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 10240)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
...
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 4))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 1028))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 6) * 1024) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) & 63) * 2)) + 4096))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 8))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 1032))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 5) * 256) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 14336)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
...
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 12))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (((int)threadIdx.x) & 3)) + 1036))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 5) * 256) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 16384)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 6) * 1024) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) & 63) * 2)) + 12288))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
  ...
  for (int ax0_0 = 0; ax0_0 < 2; ++ax0_0) {
    A_shared_dyn_local[ax0_0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)));
  }
  for (int ax1_0 = 0; ax1_0 < 2; ++ax1_0) {
    *(float4*)(B_shared_dyn_local + (ax1_0 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2560));
  }
  for (int k_0 = 0; k_0 < 252; ++k_0) {
    __syncthreads();

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (k_0 * 4)) + (((int)threadIdx.x) & 3)) + 16))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) >> 3) * 131072) + ((((int)threadIdx.x) >> 2) * 2048)) + (k_0 * 4)) + (((int)threadIdx.x) & 3)) + 1040))), "n"(4)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((k_0 + 4) % 5) * 2048) + ((((int)threadIdx.x) >> 5) * 256)) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 10240)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((k_0 * 4096) + ((((int)threadIdx.x) >> 6) * 1024)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) & 63) * 2)) + 16384))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
    ...
    for (int ax0_0_1 = 0; ax0_0_1 < 2; ++ax0_0_1) {
      A_shared_dyn_local[(ax0_0_1 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 % 5) * 512) + (((((int)threadIdx.x) & 127) >> 5) * 32)) + (ax0_0_1 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 128));
    }
    for (int ax1_0_1 = 0; ax1_0_1 < 2; ++ax1_0_1) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_1 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 512) + ((((int)threadIdx.x) >> 7) * 64)) + (ax1_0_1 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2688));
    }
    ...
    for (int ax0_0_2 = 0; ax0_0_2 < 2; ++ax0_0_2) {
      A_shared_dyn_local[ax0_0_2] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 % 5) * 512) + (((((int)threadIdx.x) & 127) >> 5) * 32)) + (ax0_0_2 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 256));
    }
    for (int ax1_0_2 = 0; ax1_0_2 < 2; ++ax1_0_2) {
      *(float4*)(B_shared_dyn_local + (ax1_0_2 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 512) + ((((int)threadIdx.x) >> 7) * 64)) + (ax1_0_2 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2816));
    }
    ...
    for (int ax0_0_3 = 0; ax0_0_3 < 2; ++ax0_0_3) {
      A_shared_dyn_local[(ax0_0_3 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 % 5) * 512) + (((((int)threadIdx.x) & 127) >> 5) * 32)) + (ax0_0_3 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 384));
    }
    for (int ax1_0_3 = 0; ax1_0_3 < 2; ++ax1_0_3) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_3 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 512) + ((((int)threadIdx.x) >> 7) * 64)) + (ax1_0_3 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2944));
    }
    ...
    for (int ax0_0_4 = 0; ax0_0_4 < 2; ++ax0_0_4) {
      A_shared_dyn_local[ax0_0_4] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 + 1) % 5) * 512) + (((((int)threadIdx.x) & 127) >> 5) * 32)) + (ax0_0_4 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)));
    }
    for (int ax1_0_4 = 0; ax1_0_4 < 2; ++ax1_0_4) {
      *(float4*)(B_shared_dyn_local + (ax1_0_4 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 + 1) % 5) * 512) + ((((int)threadIdx.x) >> 7) * 64)) + (ax1_0_4 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2560));
    }
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  for (int ax0_0_5 = 0; ax0_0_5 < 2; ++ax0_0_5) {
    A_shared_dyn_local[(ax0_0_5 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_5 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1152));
  }
  for (int ax1_0_5 = 0; ax1_0_5 < 2; ++ax1_0_5) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_5 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_5 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 3712));
  }
  ...
  for (int ax0_0_6 = 0; ax0_0_6 < 2; ++ax0_0_6) {
    A_shared_dyn_local[ax0_0_6] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_6 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1280));
  }
  for (int ax1_0_6 = 0; ax1_0_6 < 2; ++ax1_0_6) {
    *(float4*)(B_shared_dyn_local + (ax1_0_6 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_6 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 3840));
  }
  ...
  for (int ax0_0_7 = 0; ax0_0_7 < 2; ++ax0_0_7) {
    A_shared_dyn_local[(ax0_0_7 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_7 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1408));
  }
  for (int ax1_0_7 = 0; ax1_0_7 < 2; ++ax1_0_7) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_7 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_7 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 3968));
  }
  ...
  for (int ax0_0_8 = 0; ax0_0_8 < 2; ++ax0_0_8) {
    A_shared_dyn_local[ax0_0_8] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_8 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1536));
  }
  for (int ax1_0_8 = 0; ax1_0_8 < 2; ++ax1_0_8) {
    *(float4*)(B_shared_dyn_local + (ax1_0_8 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_8 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4096));
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  for (int ax0_0_9 = 0; ax0_0_9 < 2; ++ax0_0_9) {
    A_shared_dyn_local[(ax0_0_9 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_9 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1664));
  }
  for (int ax1_0_9 = 0; ax1_0_9 < 2; ++ax1_0_9) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_9 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_9 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4224));
  }
  ...
  for (int ax0_0_10 = 0; ax0_0_10 < 2; ++ax0_0_10) {
    A_shared_dyn_local[ax0_0_10] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_10 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1792));
  }
  for (int ax1_0_10 = 0; ax1_0_10 < 2; ++ax1_0_10) {
    *(float4*)(B_shared_dyn_local + (ax1_0_10 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_10 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4352));
  }
  ...
  for (int ax0_0_11 = 0; ax0_0_11 < 2; ++ax0_0_11) {
    A_shared_dyn_local[(ax0_0_11 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_11 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 1920));
  }
  for (int ax1_0_11 = 0; ax1_0_11 < 2; ++ax1_0_11) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_11 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_11 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4480));
  }
  ...
  for (int ax0_0_12 = 0; ax0_0_12 < 2; ++ax0_0_12) {
    A_shared_dyn_local[ax0_0_12] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_12 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 2048));
  }
  for (int ax1_0_12 = 0; ax1_0_12 < 2; ++ax1_0_12) {
    *(float4*)(B_shared_dyn_local + (ax1_0_12 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_12 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4608));
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  for (int ax0_0_13 = 0; ax0_0_13 < 2; ++ax0_0_13) {
    A_shared_dyn_local[(ax0_0_13 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_13 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 2176));
  }
  for (int ax1_0_13 = 0; ax1_0_13 < 2; ++ax1_0_13) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_13 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_13 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4736));
  }
  ...
  for (int ax0_0_14 = 0; ax0_0_14 < 2; ++ax0_0_14) {
    A_shared_dyn_local[ax0_0_14] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_14 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 2304));
  }
  for (int ax1_0_14 = 0; ax1_0_14 < 2; ++ax1_0_14) {
    *(float4*)(B_shared_dyn_local + (ax1_0_14 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_14 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4864));
  }
  ...
  for (int ax0_0_15 = 0; ax0_0_15 < 2; ++ax0_0_15) {
    A_shared_dyn_local[(ax0_0_15 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_15 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 2432));
  }
  for (int ax1_0_15 = 0; ax1_0_15 < 2; ++ax1_0_15) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_15 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_15 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 4992));
  }
  ...
  for (int ax0_0_16 = 0; ax0_0_16 < 2; ++ax0_0_16) {
    A_shared_dyn_local[ax0_0_16] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_16 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)));
  }
  for (int ax1_0_16 = 0; ax1_0_16 < 2; ++ax1_0_16) {
    *(float4*)(B_shared_dyn_local + (ax1_0_16 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_16 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2560));
  }
  ...
  for (int ax0_0_17 = 0; ax0_0_17 < 2; ++ax0_0_17) {
    A_shared_dyn_local[(ax0_0_17 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_17 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 128));
  }
  for (int ax1_0_17 = 0; ax1_0_17 < 2; ++ax1_0_17) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_17 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_17 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2688));
  }
  ...
  for (int ax0_0_18 = 0; ax0_0_18 < 2; ++ax0_0_18) {
    A_shared_dyn_local[ax0_0_18] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_18 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 256));
  }
  for (int ax1_0_18 = 0; ax1_0_18 < 2; ++ax1_0_18) {
    *(float4*)(B_shared_dyn_local + (ax1_0_18 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_18 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2816));
  }
  ...
  for (int ax0_0_19 = 0; ax0_0_19 < 2; ++ax0_0_19) {
    A_shared_dyn_local[(ax0_0_19 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((int)threadIdx.x) & 127) >> 5) * 32) + (ax0_0_19 * 16)) + (((((int)threadIdx.x) & 31) >> 4) * 8)) + ((((int)threadIdx.x) & 1) * 4)) + 384));
  }
  for (int ax1_0_19 = 0; ax1_0_19 < 2; ++ax1_0_19) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_19 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) >> 7) * 64) + (ax1_0_19 * 32)) + (((((int)threadIdx.x) & 15) >> 1) * 4)) + 2944));
  }
  ...
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8))) = *(float4*)(Y_local + 0);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 4)) = *(float4*)(Y_local + 4);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 1024)) = *(float4*)(Y_local + 8);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 1028)) = *(float4*)(Y_local + 12);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 2048)) = *(float4*)(Y_local + 16);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 2052)) = *(float4*)(Y_local + 20);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 3072)) = *(float4*)(Y_local + 24);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 3076)) = *(float4*)(Y_local + 28);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 4096)) = *(float4*)(Y_local + 32);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 4100)) = *(float4*)(Y_local + 36);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 5120)) = *(float4*)(Y_local + 40);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 5124)) = *(float4*)(Y_local + 44);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 6144)) = *(float4*)(Y_local + 48);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 6148)) = *(float4*)(Y_local + 52);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 7168)) = *(float4*)(Y_local + 56);
  *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 131072) + (((((int)threadIdx.x) & 127) >> 4) * 16384)) + ((((int)threadIdx.x) & 1) * 8192)) + ((((int)blockIdx.x) & 7) * 128)) + ((((int)threadIdx.x) >> 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + 7172)) = *(float4*)(Y_local + 60);
}
