...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v9, v10, v11 = sch.sample_perfect_tile(loop=l6, n=3, max_innermost_factor=16, decision=[8, 23, 8])
  v12, v13, v14 = sch.sample_perfect_tile(loop=l7, n=3, max_innermost_factor=16, decision=[8, 12, 12])
  v15, v16 = sch.sample_perfect_tile(loop=l8, n=2, max_innermost_factor=8, decision=[100, 8])
  ...
  v26, v27, v28 = sch.sample_perfect_tile(loop=l18, n=3, max_innermost_factor=16, decision=[23, 1, 1])
  v29, v30 = sch.sample_perfect_tile(loop=l21, n=2, max_innermost_factor=16, decision=[3, 4])
  ...
  v45, v46 = sch.sample_perfect_tile(loop=l44, n=2, max_innermost_factor=16, decision=[1, 8])
  ...
  v55, v56 = sch.sample_perfect_tile(loop=l54, n=2, max_innermost_factor=16, decision=[6, 2])
  ...
  sch.unroll(loop=l86)
  v88, v89 = sch.sample_perfect_tile(loop=l87, n=2, max_innermost_factor=16, decision=[3, 4])
