                ...
                for j_2_init in T.unroll(8):
                    for i_2_0_init in T.unroll(4):
                        for i_2_1_init in T.unroll(4):
                            with T.block("Y_init"):
                                v_i = T.axis.spatial(2048, i_0_j_0_fused // 16 * 256 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 64 * 64 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 64 // 32 * 32 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 16 + i_2_0_init * 4 + i_2_1_init)
                                v_j = T.axis.spatial(2048, i_0_j_0_fused % 16 * 128 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 8 + j_2_init)
                                T.reads()
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(256, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.vectorized(4):
                            with T.block("A_shared.dyn"):
                                v0 = T.axis.spatial(2048, k_0 * 4 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 16 * 64 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 16 * 4 + ax0_ax1_fused_2) // 256)
                                v1 = T.axis.spatial(2048, i_0_j_0_fused // 16 * 256 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 16 * 64 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 16 * 4 + ax0_ax1_fused_2) % 256)
                                T.reads(A[v0, v1])
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(256, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.serial(2):
                            with T.block("B_shared.dyn"):
                                v0 = T.axis.spatial(2048, k_0 * 4 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 16 * 32 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 16 * 2 + ax0_ax1_fused_2) // 128)
                                v1 = T.axis.spatial(2048, i_0_j_0_fused % 16 * 128 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 16 * 32 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 16 * 2 + ax0_ax1_fused_2) % 128)
                                T.reads(B[v0, v1])
                        ...
                        for ax0, ax1_0 in T.grid(1, 4):
                            for ax1_1 in T.vectorized(4):
                                with T.block("A_shared.dyn_local"):
                                    ...
                                    v1 = T.axis.spatial(2048, i_0_j_0_fused // 16 * 256 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 32 * 32 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 16 + ax1_0 * 4 + ax1_1)
                        ...
                        for ax0, ax1_0 in T.grid(1, 2):
                            for ax1_1 in T.vectorized(4):
                                with T.block("B_shared.dyn_local"):
                                    v0 = T.axis.spatial(2048, ax0 + k_0 * 4 + k_1)
                                    v1 = T.axis.spatial(2048, i_0_j_0_fused % 16 * 128 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 8 + ax1_0 * 4 + ax1_1)
                            ...
                            for i_2_0 in T.unroll(4):
                                for i_2_1 in T.vectorized(4):
                                    with T.block("Y_update"):
                                        v_i = T.axis.spatial(2048, i_0_j_0_fused // 16 * 256 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 64 * 64 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 64 // 32 * 32 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 16 + i_2_0 * 4 + i_2_1)
                                        v_j = T.axis.spatial(2048, i_0_j_0_fused % 16 * 128 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 8 + j_2)
                    ...
                    for ax1_0 in T.serial(2):
                        for ax1_1 in T.vectorized(4):
                            with T.block("Y_local"):
                                v0 = T.axis.spatial(2048, i_0_j_0_fused // 16 * 256 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 32 * 32 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 16 + ax0)
                                v1 = T.axis.spatial(2048, i_0_j_0_fused % 16 * 128 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 8 + ax1_0 * 4 + ax1_1)
