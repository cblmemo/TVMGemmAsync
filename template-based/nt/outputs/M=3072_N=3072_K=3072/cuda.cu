...
extern "C" __global__ void __launch_bounds__(192) main_kernel0(float* __restrict__ A, float* __restrict__ B, float* __restrict__ Y) {
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)threadIdx.x) / 48) * 3072) + ((((int)blockIdx.x) >> 4) * 96)) + ((((int)threadIdx.x) % 48) * 2)))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 4) * 256) + ((((int)threadIdx.x) & 1) * 128)) + (((((int)threadIdx.x) & 15) >> 1) * 16)) + (ax0_ax1_fused_2 * 4)) + 6144)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
...
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 4) * 128) + (((((int)threadIdx.x) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 15) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 1536)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)threadIdx.x) / 48) * 3072) + ((((int)blockIdx.x) >> 4) * 96)) + ((((int)threadIdx.x) % 48) * 2)) + 12288))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 4) * 256) + ((((int)threadIdx.x) & 1) * 128)) + (((((int)threadIdx.x) & 15) >> 1) * 16)) + (ax0_ax1_fused_2_1 * 4)) + 9216)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((((int)threadIdx.x) / 48) * 3072) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) % 48) * 4)) + ax0_ax1_fused_2_1) + 12288))), "n"(4)
    );
  }
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)threadIdx.x) / 48) * 3072) + ((((int)blockIdx.x) >> 4) * 96)) + ((((int)threadIdx.x) % 48) * 2)) + 24576))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((((int)threadIdx.x) / 48) * 3072) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) % 48) * 4)) + ax0_ax1_fused_2_2) + 24576))), "n"(4)
    );
  }
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  for (int ax1_0 = 0; ax1_0 < 3; ++ax1_0) {
    A_shared_dyn_local[ax1_0] = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0 * 4)) >> 5) * 32) + (((ax1_0 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0 * 4)) >> 3)) & 3) * 4)));
  }
  for (int ax1_0_1 = 0; ax1_0_1 < 2; ++ax1_0_1) {
    *(float4*)(B_shared_dyn_local + (ax1_0_1 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_1 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 1536));
  }
  for (int k_0 = 0; k_0 < 765; ++k_0) {
    __syncthreads();

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((k_0 + 3) & 3) * 1536) + ((((int)threadIdx.x) >> 4) * 128)) + (((((int)threadIdx.x) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 15) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((k_0 * 12288) + ((((int)threadIdx.x) / 48) * 3072)) + ((((int)blockIdx.x) >> 4) * 96)) + ((((int)threadIdx.x) % 48) * 2)) + 36864))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((k_0 + 3) & 3) * 3072) + ((((int)threadIdx.x) >> 4) * 256)) + ((((int)threadIdx.x) & 1) * 128)) + (((((int)threadIdx.x) & 15) >> 1) * 16)) + (ax0_ax1_fused_2_3 * 4)) + 6144)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((k_0 * 12288) + ((((int)threadIdx.x) / 48) * 3072)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) % 48) * 4)) + ax0_ax1_fused_2_3) + 36864))), "n"(4)
    );
  }
    }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 2;");
    ...
    for (int ax1_0_2 = 0; ax1_0_2 < 3; ++ax1_0_2) {
      A_shared_dyn_local[(ax1_0_2 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 & 3) * 384) + (((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_2 * 4)) >> 5) * 32)) + (((ax1_0_2 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_2 * 4)) >> 3)) & 3) * 4)) + 96));
    }
    for (int ax1_0_3 = 0; ax1_0_3 < 2; ++ax1_0_3) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_3 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 768) + ((((int)threadIdx.x) >> 6) * 64)) + (ax1_0_3 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 1728));
    }
    ...
    for (int ax1_0_4 = 0; ax1_0_4 < 3; ++ax1_0_4) {
      A_shared_dyn_local[ax1_0_4] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 & 3) * 384) + (((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_4 * 4)) >> 5) * 32)) + (((ax1_0_4 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_4 * 4)) >> 3)) & 3) * 4)) + 192));
    }
    for (int ax1_0_5 = 0; ax1_0_5 < 2; ++ax1_0_5) {
      *(float4*)(B_shared_dyn_local + (ax1_0_5 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 768) + ((((int)threadIdx.x) >> 6) * 64)) + (ax1_0_5 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 1920));
    }
    ...
    for (int ax1_0_6 = 0; ax1_0_6 < 3; ++ax1_0_6) {
      A_shared_dyn_local[(ax1_0_6 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 & 3) * 384) + (((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_6 * 4)) >> 5) * 32)) + (((ax1_0_6 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_6 * 4)) >> 3)) & 3) * 4)) + 288));
    }
    for (int ax1_0_7 = 0; ax1_0_7 < 2; ++ax1_0_7) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_7 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 768) + ((((int)threadIdx.x) >> 6) * 64)) + (ax1_0_7 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 2112));
    }
    ...
    for (int ax1_0_8 = 0; ax1_0_8 < 3; ++ax1_0_8) {
      A_shared_dyn_local[ax1_0_8] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 + 1) & 3) * 384) + (((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_8 * 4)) >> 5) * 32)) + (((ax1_0_8 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_8 * 4)) >> 3)) & 3) * 4)));
    }
    for (int ax1_0_9 = 0; ax1_0_9 < 2; ++ax1_0_9) {
      *(float4*)(B_shared_dyn_local + (ax1_0_9 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((k_0 + 1) & 3) * 768) + ((((int)threadIdx.x) >> 6) * 64)) + (ax1_0_9 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 1536));
    }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  for (int ax1_0_10 = 0; ax1_0_10 < 3; ++ax1_0_10) {
    A_shared_dyn_local[(ax1_0_10 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_10 * 4)) >> 5) * 32) + (((ax1_0_10 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_10 * 4)) >> 3)) & 3) * 4)) + 480));
  }
  for (int ax1_0_11 = 0; ax1_0_11 < 2; ++ax1_0_11) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_11 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_11 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 2496));
  }
  ...
  for (int ax1_0_12 = 0; ax1_0_12 < 3; ++ax1_0_12) {
    A_shared_dyn_local[ax1_0_12] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_12 * 4)) >> 5) * 32) + (((ax1_0_12 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_12 * 4)) >> 3)) & 3) * 4)) + 576));
  }
  for (int ax1_0_13 = 0; ax1_0_13 < 2; ++ax1_0_13) {
    *(float4*)(B_shared_dyn_local + (ax1_0_13 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_13 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 2688));
  }
  ...
  for (int ax1_0_14 = 0; ax1_0_14 < 3; ++ax1_0_14) {
    A_shared_dyn_local[(ax1_0_14 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_14 * 4)) >> 5) * 32) + (((ax1_0_14 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_14 * 4)) >> 3)) & 3) * 4)) + 672));
  }
  for (int ax1_0_15 = 0; ax1_0_15 < 2; ++ax1_0_15) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_15 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_15 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 2880));
  }
  ...
  for (int ax1_0_16 = 0; ax1_0_16 < 3; ++ax1_0_16) {
    A_shared_dyn_local[ax1_0_16] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_16 * 4)) >> 5) * 32) + (((ax1_0_16 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_16 * 4)) >> 3)) & 3) * 4)) + 768));
  }
  for (int ax1_0_17 = 0; ax1_0_17 < 2; ++ax1_0_17) {
    *(float4*)(B_shared_dyn_local + (ax1_0_17 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_17 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 3072));
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  for (int ax1_0_18 = 0; ax1_0_18 < 3; ++ax1_0_18) {
    A_shared_dyn_local[(ax1_0_18 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_18 * 4)) >> 5) * 32) + (((ax1_0_18 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_18 * 4)) >> 3)) & 3) * 4)) + 864));
  }
  for (int ax1_0_19 = 0; ax1_0_19 < 2; ++ax1_0_19) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_19 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_19 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 3264));
  }
  ...
  for (int ax1_0_20 = 0; ax1_0_20 < 3; ++ax1_0_20) {
    A_shared_dyn_local[ax1_0_20] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_20 * 4)) >> 5) * 32) + (((ax1_0_20 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_20 * 4)) >> 3)) & 3) * 4)) + 960));
  }
  for (int ax1_0_21 = 0; ax1_0_21 < 2; ++ax1_0_21) {
    *(float4*)(B_shared_dyn_local + (ax1_0_21 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_21 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 3456));
  }
  ...
  for (int ax1_0_22 = 0; ax1_0_22 < 3; ++ax1_0_22) {
    A_shared_dyn_local[(ax1_0_22 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_22 * 4)) >> 5) * 32) + (((ax1_0_22 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_22 * 4)) >> 3)) & 3) * 4)) + 1056));
  }
  for (int ax1_0_23 = 0; ax1_0_23 < 2; ++ax1_0_23) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_23 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_23 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 3648));
  }
  ...
  for (int ax1_0_24 = 0; ax1_0_24 < 3; ++ax1_0_24) {
    A_shared_dyn_local[ax1_0_24] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_24 * 4)) >> 5) * 32) + (((ax1_0_24 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_24 * 4)) >> 3)) & 3) * 4)) + 1152));
  }
  for (int ax1_0_25 = 0; ax1_0_25 < 2; ++ax1_0_25) {
    *(float4*)(B_shared_dyn_local + (ax1_0_25 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_25 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 3840));
  }
  ...
  for (int ax1_0_26 = 0; ax1_0_26 < 3; ++ax1_0_26) {
    A_shared_dyn_local[(ax1_0_26 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_26 * 4)) >> 5) * 32) + (((ax1_0_26 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_26 * 4)) >> 3)) & 3) * 4)) + 1248));
  }
  for (int ax1_0_27 = 0; ax1_0_27 < 2; ++ax1_0_27) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_27 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_27 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 4032));
  }
  ...
  for (int ax1_0_28 = 0; ax1_0_28 < 3; ++ax1_0_28) {
    A_shared_dyn_local[ax1_0_28] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_28 * 4)) >> 5) * 32) + (((ax1_0_28 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_28 * 4)) >> 3)) & 3) * 4)) + 1344));
  }
  for (int ax1_0_29 = 0; ax1_0_29 < 2; ++ax1_0_29) {
    *(float4*)(B_shared_dyn_local + (ax1_0_29 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_29 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 4224));
  }
  ...
  for (int ax1_0_30 = 0; ax1_0_30 < 3; ++ax1_0_30) {
    A_shared_dyn_local[(ax1_0_30 + 3)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)threadIdx.x) & 15) >> 2) * 24) + ((((int)threadIdx.x) & 1) * 12)) + (ax1_0_30 * 4)) >> 5) * 32) + (((ax1_0_30 + (((int)threadIdx.x) & 1)) & 1) * 16)) + ((((((((int)threadIdx.x) & 15) >> 2) * 3) + ((((((int)threadIdx.x) & 1) * 12) + (ax1_0_30 * 4)) >> 3)) & 3) * 4)) + 1440));
  }
  for (int ax1_0_31 = 0; ax1_0_31 < 2; ++ax1_0_31) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_31 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 64) + (ax1_0_31 * 32)) + (((((int)threadIdx.x) & 63) >> 4) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 4416));
  }
  ...
  for (int ax1_0_32 = 0; ax1_0_32 < 2; ++ax1_0_32) {
    *(float4*)(Y + ((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_32 * 4))) = *(float4*)(Y_local + (ax1_0_32 * 4));
  }
  for (int ax1_0_33 = 0; ax1_0_33 < 2; ++ax1_0_33) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_33 * 4)) + 3072)) = *(float4*)(Y_local + ((ax1_0_33 * 4) + 8));
  }
  for (int ax1_0_34 = 0; ax1_0_34 < 2; ++ax1_0_34) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_34 * 4)) + 6144)) = *(float4*)(Y_local + ((ax1_0_34 * 4) + 16));
  }
  for (int ax1_0_35 = 0; ax1_0_35 < 2; ++ax1_0_35) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_35 * 4)) + 9216)) = *(float4*)(Y_local + ((ax1_0_35 * 4) + 24));
  }
  for (int ax1_0_36 = 0; ax1_0_36 < 2; ++ax1_0_36) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_36 * 4)) + 12288)) = *(float4*)(Y_local + ((ax1_0_36 * 4) + 32));
  }
  for (int ax1_0_37 = 0; ax1_0_37 < 2; ++ax1_0_37) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_37 * 4)) + 15360)) = *(float4*)(Y_local + ((ax1_0_37 * 4) + 40));
  }
  for (int ax1_0_38 = 0; ax1_0_38 < 2; ++ax1_0_38) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_38 * 4)) + 18432)) = *(float4*)(Y_local + ((ax1_0_38 * 4) + 48));
  }
  for (int ax1_0_39 = 0; ax1_0_39 < 2; ++ax1_0_39) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_39 * 4)) + 21504)) = *(float4*)(Y_local + ((ax1_0_39 * 4) + 56));
  }
  for (int ax1_0_40 = 0; ax1_0_40 < 2; ++ax1_0_40) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_40 * 4)) + 24576)) = *(float4*)(Y_local + ((ax1_0_40 * 4) + 64));
  }
  for (int ax1_0_41 = 0; ax1_0_41 < 2; ++ax1_0_41) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_41 * 4)) + 27648)) = *(float4*)(Y_local + ((ax1_0_41 * 4) + 72));
  }
  for (int ax1_0_42 = 0; ax1_0_42 < 2; ++ax1_0_42) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_42 * 4)) + 30720)) = *(float4*)(Y_local + ((ax1_0_42 * 4) + 80));
  }
  for (int ax1_0_43 = 0; ax1_0_43 < 2; ++ax1_0_43) {
    *(float4*)(Y + (((((((((((int)blockIdx.x) >> 4) * 294912) + (((((int)threadIdx.x) & 15) >> 2) * 73728)) + ((((int)threadIdx.x) & 1) * 36864)) + ((((int)blockIdx.x) & 15) * 192)) + ((((int)threadIdx.x) >> 4) * 16)) + (((((int)threadIdx.x) & 3) >> 1) * 8)) + (ax1_0_43 * 4)) + 33792)) = *(float4*)(Y_local + ((ax1_0_43 * 4) + 88));
  }
}
