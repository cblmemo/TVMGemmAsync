...
extern "C" __global__ void __launch_bounds__(128) main_kernel0(float* __restrict__ A, float* __restrict__ B, float* __restrict__ Y) {
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) >> 3) * 64)) + ((((int)threadIdx.x) & 31) * 2)))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((((int)threadIdx.x) >> 5) * 3072) + (((((((int)blockIdx.x) & 7) * 3) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2) >> 5)) >> 1) * 256)) + (((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2) & 7) >> 2) * 128)) + (((((((int)blockIdx.x) & 7) * 4) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2) >> 3)) & 7) * 16)) + ((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2) & 3) * 4)) + 4096) - (max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64)) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 768) + ((((int)blockIdx.x) & 7) * 96)) + ((((int)threadIdx.x) & 31) * 3)) + ax0_ax1_fused_2))), "n"(4)
    );
  }
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) >> 3) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 2048))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((((int)threadIdx.x) >> 5) * 3072) + (((((((int)blockIdx.x) & 7) * 3) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2_1) >> 5)) >> 1) * 256)) + (((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2_1) & 7) >> 2) * 128)) + (((((((int)blockIdx.x) & 7) * 4) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2_1) >> 3)) & 7) * 16)) + ((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2_1) & 3) * 4)) + 16384) - (max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64)) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((((int)threadIdx.x) >> 5) * 768) + ((((int)blockIdx.x) & 7) * 96)) + ((((int)threadIdx.x) & 31) * 3)) + ax0_ax1_fused_2_1) + 3072))), "n"(4)
    );
  }
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) >> 3) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 4096))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((((int)threadIdx.x) >> 5) * 3072) + (((((((int)blockIdx.x) & 7) * 3) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2_2) >> 5)) >> 1) * 256)) + (((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2_2) & 7) >> 2) * 128)) + (((((((int)blockIdx.x) & 7) * 4) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2_2) >> 3)) & 7) * 16)) + ((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2_2) & 3) * 4)) + 28672) - (max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64)) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((((int)threadIdx.x) >> 5) * 768) + ((((int)blockIdx.x) & 7) * 96)) + ((((int)threadIdx.x) & 31) * 3)) + ax0_ax1_fused_2_2) + 6144))), "n"(4)
    );
  }
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  for (int ax1_0 = 0; ax1_0 < 3; ++ax1_0) {
    *(float4*)(B_shared_dyn_local + (ax1_0 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0 * 4)) >> 3)) & 7) * 4)) + 1024) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((k_0 * 2048) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)blockIdx.x) >> 3) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 6144))), "n"(8)
    );
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((((k_0 + 3) & 3) * 12288) + ((((int)threadIdx.x) >> 5) * 3072)) + (((((((int)blockIdx.x) & 7) * 3) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2_3) >> 5)) >> 1) * 256)) + (((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2_3) & 7) >> 2) * 128)) + (((((((int)blockIdx.x) & 7) * 4) + ((((((int)threadIdx.x) & 31) * 3) + ax0_ax1_fused_2_3) >> 3)) & 7) * 16)) + ((((((int)threadIdx.x) * 3) + ax0_ax1_fused_2_3) & 3) * 4)) + 4096) - (max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64)) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((k_0 * 3072) + ((((int)threadIdx.x) >> 5) * 768)) + ((((int)blockIdx.x) & 7) * 96)) + ((((int)threadIdx.x) & 31) * 3)) + ax0_ax1_fused_2_3) + 9216))), "n"(4)
    );
  }
    }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 2;");
    ...
    __syncthreads();
    A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 256) + ((((int)threadIdx.x) >> 6) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 64));
    for (int ax1_0_1 = 0; ax1_0_1 < 3; ++ax1_0_1) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_1 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 3072) + ((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_1 * 4)) >> 6) * 64)) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_1) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_1 * 4)) >> 3)) & 7) * 4)) + 1792) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
    }
    ...
    A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 256) + ((((int)threadIdx.x) >> 6) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 128));
    for (int ax1_0_2 = 0; ax1_0_2 < 3; ++ax1_0_2) {
      *(float4*)(B_shared_dyn_local + (ax1_0_2 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 3072) + ((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_2 * 4)) >> 6) * 64)) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_2) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_2 * 4)) >> 3)) & 7) * 4)) + 2560) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
    }
    ...
    A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 256) + ((((int)threadIdx.x) >> 6) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 192));
    for (int ax1_0_3 = 0; ax1_0_3 < 3; ++ax1_0_3) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_3 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 & 3) * 3072) + ((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_3 * 4)) >> 6) * 64)) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_3) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_3 * 4)) >> 3)) & 7) * 4)) + 3328) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
    }
    ...
    A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 + 1) & 3) * 256) + ((((int)threadIdx.x) >> 6) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)));
    for (int ax1_0_4 = 0; ax1_0_4 < 3; ++ax1_0_4) {
      *(float4*)(B_shared_dyn_local + (ax1_0_4 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((k_0 + 1) & 3) * 3072) + ((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_4 * 4)) >> 6) * 64)) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_4) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_4 * 4)) >> 3)) & 7) * 4)) + 1024) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
    }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  __syncthreads();
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 32) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 320));
  for (int ax1_0_5 = 0; ax1_0_5 < 3; ++ax1_0_5) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_5 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_5 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_5) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_5 * 4)) >> 3)) & 7) * 4)) + 4864) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 32) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 384));
  for (int ax1_0_6 = 0; ax1_0_6 < 3; ++ax1_0_6) {
    *(float4*)(B_shared_dyn_local + (ax1_0_6 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_6 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_6) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_6 * 4)) >> 3)) & 7) * 4)) + 5632) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  A_shared_dyn_local[1] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 32) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 448));
  for (int ax1_0_7 = 0; ax1_0_7 < 3; ++ax1_0_7) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_7 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_7 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_7) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_7 * 4)) >> 3)) & 7) * 4)) + 6400) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  A_shared_dyn_local[0] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) >> 6) * 32) + ((((int)threadIdx.x) & 1) * 16)) + (((((int)threadIdx.x) & 63) >> 5) * 8)) + (((((int)threadIdx.x) & 3) >> 1) * 4)) + 512));
  for (int ax1_0_8 = 0; ax1_0_8 < 3; ++ax1_0_8) {
    *(float4*)(B_shared_dyn_local + (ax1_0_8 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_8 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_8) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_8 * 4)) >> 3)) & 7) * 4)) + 7168) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  for (int ax1_0_9 = 0; ax1_0_9 < 3; ++ax1_0_9) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_9 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_9 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_9) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_9 * 4)) >> 3)) & 7) * 4)) + 7936) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_10 = 0; ax1_0_10 < 3; ++ax1_0_10) {
    *(float4*)(B_shared_dyn_local + (ax1_0_10 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_10 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_10) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_10 * 4)) >> 3)) & 7) * 4)) + 8704) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_11 = 0; ax1_0_11 < 3; ++ax1_0_11) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_11 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_11 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_11) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_11 * 4)) >> 3)) & 7) * 4)) + 9472) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_12 = 0; ax1_0_12 < 3; ++ax1_0_12) {
    *(float4*)(B_shared_dyn_local + (ax1_0_12 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_12 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_12) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_12 * 4)) >> 3)) & 7) * 4)) + 10240) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_13 = 0; ax1_0_13 < 3; ++ax1_0_13) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_13 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_13 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_13) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_13 * 4)) >> 3)) & 7) * 4)) + 11008) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_14 = 0; ax1_0_14 < 3; ++ax1_0_14) {
    *(float4*)(B_shared_dyn_local + (ax1_0_14 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_14 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_14) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_14 * 4)) >> 3)) & 7) * 4)) + 11776) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_15 = 0; ax1_0_15 < 3; ++ax1_0_15) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_15 * 4) + 12)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((((((int)blockIdx.x) & 7) * 96) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_15 * 4)) >> 6) * 64) + (((((((int)threadIdx.x) & 31) >> 2) + ax1_0_15) & 1) * 32)) + (((((((int)blockIdx.x) & 7) * 4) + (((((((int)threadIdx.x) & 31) >> 2) * 12) + (ax1_0_15 * 4)) >> 3)) & 7) * 4)) + 12544) - max(0, ((min((((((int)blockIdx.x) & 7) * 96) - ((((int)blockIdx.x) & 1) * 32)), ((((int)blockIdx.x) & 7) * 96)) >> 6) * 64))));
  }
  ...
  for (int ax1_0_16 = 0; ax1_0_16 < 3; ++ax1_0_16) {
    *(float4*)(Y + (((((((((int)blockIdx.x) >> 3) * 49152) + ((((int)threadIdx.x) >> 5) * 12288)) + ((((int)threadIdx.x) & 3) * 3072)) + ((((int)blockIdx.x) & 7) * 96)) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_16 * 4))) = *(float4*)(Y_local + (ax1_0_16 * 4));
  }
  for (int ax1_0_17 = 0; ax1_0_17 < 3; ++ax1_0_17) {
    *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 49152) + ((((int)threadIdx.x) >> 5) * 12288)) + ((((int)threadIdx.x) & 3) * 3072)) + ((((int)blockIdx.x) & 7) * 96)) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_17 * 4)) + 768)) = *(float4*)(Y_local + ((ax1_0_17 * 4) + 12));
  }
  for (int ax1_0_18 = 0; ax1_0_18 < 3; ++ax1_0_18) {
    *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 49152) + ((((int)threadIdx.x) >> 5) * 12288)) + ((((int)threadIdx.x) & 3) * 3072)) + ((((int)blockIdx.x) & 7) * 96)) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_18 * 4)) + 1536)) = *(float4*)(Y_local + ((ax1_0_18 * 4) + 24));
  }
  for (int ax1_0_19 = 0; ax1_0_19 < 3; ++ax1_0_19) {
    *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 49152) + ((((int)threadIdx.x) >> 5) * 12288)) + ((((int)threadIdx.x) & 3) * 3072)) + ((((int)blockIdx.x) & 7) * 96)) + (((((int)threadIdx.x) & 31) >> 2) * 12)) + (ax1_0_19 * 4)) + 2304)) = *(float4*)(Y_local + ((ax1_0_19 * 4) + 36));
  }
}
