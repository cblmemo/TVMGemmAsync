...
extern "C" __global__ void __launch_bounds__(256) main_kernel0(float* __restrict__ A, float* __restrict__ B, float* __restrict__ Y) {
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 2)))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) & 7) * 64)) + ((((int)threadIdx.x) & 31) * 2)))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 2)) + 8))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 5) * 256) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 2048)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) & 7) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 4096))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((int)threadIdx.x) >> 2) * 80) + (((((int)threadIdx.x) & 3) >> 1) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 20480)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 2)) + 16))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) & 7) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 8192))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((int)threadIdx.x) >> 2) * 80) + (((((int)threadIdx.x) & 3) >> 1) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 25600)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 2) * 512)) + ((((int)threadIdx.x) & 3) * 2)) + 24))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) >> 5) * 256) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 6144)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) >> 5) * 512) + ((((int)blockIdx.x) & 7) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 12288))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
  ...
  for (int ax0_1_s = 0; ax0_1_s < 4; ++ax0_1_s) {
    if (ax0_1_s < 2) {
      A_shared_dyn_local[ax0_1_s] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s * 20)) + 2560)];
    }
  }
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((k_0 + 4) % 5) * 5120) + ((((int)threadIdx.x) >> 2) * 80)) + (((((int)threadIdx.x) & 3) >> 1) * 64)) + ((((int)threadIdx.x) & 1) * 8)) + 10240)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 2) * 512)) + (k_0 * 8)) + ((((int)threadIdx.x) & 3) * 2)) + 32))), "n"(8)
    );
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((k_0 + 4) % 5) * 2048) + ((((int)threadIdx.x) >> 5) * 256)) + (((((int)threadIdx.x) & 3) >> 1) * 128)) + (((((int)threadIdx.x) & 31) >> 2) * 16)) + ((((int)threadIdx.x) & 1) * 8))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((k_0 * 4096) + ((((int)threadIdx.x) >> 5) * 512)) + ((((int)blockIdx.x) & 7) * 64)) + ((((int)threadIdx.x) & 31) * 2)) + 16384))), "n"(8)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
    ...
    for (int ax0_1_s_1 = 0; ax0_1_s_1 < 4; ++ax0_1_s_1) {
      if (ax0_1_s_1 < 2) {
        A_shared_dyn_local[(ax0_1_s_1 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_1 * 20)) + 2561)];
      }
    }
    ...
    for (int ax0_1_s_2 = 0; ax0_1_s_2 < 4; ++ax0_1_s_2) {
      if (ax0_1_s_2 < 2) {
        A_shared_dyn_local[ax0_1_s_2] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_2 * 20)) + 2562)];
      }
    }
    ...
    for (int ax0_1_s_3 = 0; ax0_1_s_3 < 4; ++ax0_1_s_3) {
      if (ax0_1_s_3 < 2) {
        A_shared_dyn_local[(ax0_1_s_3 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_3 * 20)) + 2563)];
      }
    }
    ...
    for (int ax0_1_s_4 = 0; ax0_1_s_4 < 4; ++ax0_1_s_4) {
      if (ax0_1_s_4 < 2) {
        A_shared_dyn_local[ax0_1_s_4] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_4 * 20)) + 2576)];
      }
    }
    ...
    for (int ax0_1_s_5 = 0; ax0_1_s_5 < 4; ++ax0_1_s_5) {
      if (ax0_1_s_5 < 2) {
        A_shared_dyn_local[(ax0_1_s_5 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_5 * 20)) + 2577)];
      }
    }
    ...
    for (int ax0_1_s_6 = 0; ax0_1_s_6 < 4; ++ax0_1_s_6) {
      if (ax0_1_s_6 < 2) {
        A_shared_dyn_local[ax0_1_s_6] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_6 * 20)) + 2578)];
      }
    }
    ...
    for (int ax0_1_s_7 = 0; ax0_1_s_7 < 4; ++ax0_1_s_7) {
      if (ax0_1_s_7 < 2) {
        A_shared_dyn_local[(ax0_1_s_7 + 2)] = ((float*)buf_dyn_shmem)[((((((k_0 % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_7 * 20)) + 2579)];
      }
    }
    ...
    for (int ax0_1_s_8 = 0; ax0_1_s_8 < 4; ++ax0_1_s_8) {
      if (ax0_1_s_8 < 2) {
        A_shared_dyn_local[ax0_1_s_8] = ((float*)buf_dyn_shmem)[(((((((k_0 + 1) % 5) * 1280) + ((((int)threadIdx.x) >> 4) * 80)) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_8 * 20)) + 2560)];
      }
    }
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  for (int ax0_1_s_9 = 0; ax0_1_s_9 < 4; ++ax0_1_s_9) {
    if (ax0_1_s_9 < 2) {
      A_shared_dyn_local[(ax0_1_s_9 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_9 * 20)) + 2561)];
    }
  }
  ...
  for (int ax0_1_s_10 = 0; ax0_1_s_10 < 4; ++ax0_1_s_10) {
    if (ax0_1_s_10 < 2) {
      A_shared_dyn_local[ax0_1_s_10] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_10 * 20)) + 2562)];
    }
  }
  ...
  for (int ax0_1_s_11 = 0; ax0_1_s_11 < 4; ++ax0_1_s_11) {
    if (ax0_1_s_11 < 2) {
      A_shared_dyn_local[(ax0_1_s_11 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_11 * 20)) + 2563)];
    }
  }
  ...
  for (int ax0_1_s_12 = 0; ax0_1_s_12 < 4; ++ax0_1_s_12) {
    if (ax0_1_s_12 < 2) {
      A_shared_dyn_local[ax0_1_s_12] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_12 * 20)) + 2576)];
    }
  }
  ...
  for (int ax0_1_s_13 = 0; ax0_1_s_13 < 4; ++ax0_1_s_13) {
    if (ax0_1_s_13 < 2) {
      A_shared_dyn_local[(ax0_1_s_13 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_13 * 20)) + 2577)];
    }
  }
  ...
  for (int ax0_1_s_14 = 0; ax0_1_s_14 < 4; ++ax0_1_s_14) {
    if (ax0_1_s_14 < 2) {
      A_shared_dyn_local[ax0_1_s_14] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_14 * 20)) + 2578)];
    }
  }
  ...
  for (int ax0_1_s_15 = 0; ax0_1_s_15 < 4; ++ax0_1_s_15) {
    if (ax0_1_s_15 < 2) {
      A_shared_dyn_local[(ax0_1_s_15 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_15 * 20)) + 2579)];
    }
  }
  ...
  for (int ax0_1_s_16 = 0; ax0_1_s_16 < 4; ++ax0_1_s_16) {
    if (ax0_1_s_16 < 2) {
      A_shared_dyn_local[ax0_1_s_16] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_16 * 20)) + 3840)];
    }
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  for (int ax0_1_s_17 = 0; ax0_1_s_17 < 4; ++ax0_1_s_17) {
    if (ax0_1_s_17 < 2) {
      A_shared_dyn_local[(ax0_1_s_17 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_17 * 20)) + 3841)];
    }
  }
  ...
  for (int ax0_1_s_18 = 0; ax0_1_s_18 < 4; ++ax0_1_s_18) {
    if (ax0_1_s_18 < 2) {
      A_shared_dyn_local[ax0_1_s_18] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_18 * 20)) + 3842)];
    }
  }
  ...
  for (int ax0_1_s_19 = 0; ax0_1_s_19 < 4; ++ax0_1_s_19) {
    if (ax0_1_s_19 < 2) {
      A_shared_dyn_local[(ax0_1_s_19 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_19 * 20)) + 3843)];
    }
  }
  ...
  for (int ax0_1_s_20 = 0; ax0_1_s_20 < 4; ++ax0_1_s_20) {
    if (ax0_1_s_20 < 2) {
      A_shared_dyn_local[ax0_1_s_20] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_20 * 20)) + 3856)];
    }
  }
  ...
  for (int ax0_1_s_21 = 0; ax0_1_s_21 < 4; ++ax0_1_s_21) {
    if (ax0_1_s_21 < 2) {
      A_shared_dyn_local[(ax0_1_s_21 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_21 * 20)) + 3857)];
    }
  }
  ...
  for (int ax0_1_s_22 = 0; ax0_1_s_22 < 4; ++ax0_1_s_22) {
    if (ax0_1_s_22 < 2) {
      A_shared_dyn_local[ax0_1_s_22] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_22 * 20)) + 3858)];
    }
  }
  ...
  for (int ax0_1_s_23 = 0; ax0_1_s_23 < 4; ++ax0_1_s_23) {
    if (ax0_1_s_23 < 2) {
      A_shared_dyn_local[(ax0_1_s_23 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_23 * 20)) + 3859)];
    }
  }
  ...
  for (int ax0_1_s_24 = 0; ax0_1_s_24 < 4; ++ax0_1_s_24) {
    if (ax0_1_s_24 < 2) {
      A_shared_dyn_local[ax0_1_s_24] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_24 * 20)) + 5120)];
    }
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  for (int ax0_1_s_25 = 0; ax0_1_s_25 < 4; ++ax0_1_s_25) {
    if (ax0_1_s_25 < 2) {
      A_shared_dyn_local[(ax0_1_s_25 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_25 * 20)) + 5121)];
    }
  }
  ...
  for (int ax0_1_s_26 = 0; ax0_1_s_26 < 4; ++ax0_1_s_26) {
    if (ax0_1_s_26 < 2) {
      A_shared_dyn_local[ax0_1_s_26] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_26 * 20)) + 5122)];
    }
  }
  ...
  for (int ax0_1_s_27 = 0; ax0_1_s_27 < 4; ++ax0_1_s_27) {
    if (ax0_1_s_27 < 2) {
      A_shared_dyn_local[(ax0_1_s_27 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_27 * 20)) + 5123)];
    }
  }
  ...
  for (int ax0_1_s_28 = 0; ax0_1_s_28 < 4; ++ax0_1_s_28) {
    if (ax0_1_s_28 < 2) {
      A_shared_dyn_local[ax0_1_s_28] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_28 * 20)) + 5136)];
    }
  }
  ...
  for (int ax0_1_s_29 = 0; ax0_1_s_29 < 4; ++ax0_1_s_29) {
    if (ax0_1_s_29 < 2) {
      A_shared_dyn_local[(ax0_1_s_29 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_29 * 20)) + 5137)];
    }
  }
  ...
  for (int ax0_1_s_30 = 0; ax0_1_s_30 < 4; ++ax0_1_s_30) {
    if (ax0_1_s_30 < 2) {
      A_shared_dyn_local[ax0_1_s_30] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_30 * 20)) + 5138)];
    }
  }
  ...
  for (int ax0_1_s_31 = 0; ax0_1_s_31 < 4; ++ax0_1_s_31) {
    if (ax0_1_s_31 < 2) {
      A_shared_dyn_local[(ax0_1_s_31 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_31 * 20)) + 5139)];
    }
  }
  ...
  for (int ax0_1_s_32 = 0; ax0_1_s_32 < 4; ++ax0_1_s_32) {
    if (ax0_1_s_32 < 2) {
      A_shared_dyn_local[ax0_1_s_32] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_32 * 20)) + 6400)];
    }
  }
  ...
  for (int ax0_1_s_33 = 0; ax0_1_s_33 < 4; ++ax0_1_s_33) {
    if (ax0_1_s_33 < 2) {
      A_shared_dyn_local[(ax0_1_s_33 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_33 * 20)) + 6401)];
    }
  }
  ...
  for (int ax0_1_s_34 = 0; ax0_1_s_34 < 4; ++ax0_1_s_34) {
    if (ax0_1_s_34 < 2) {
      A_shared_dyn_local[ax0_1_s_34] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_34 * 20)) + 6402)];
    }
  }
  ...
  for (int ax0_1_s_35 = 0; ax0_1_s_35 < 4; ++ax0_1_s_35) {
    if (ax0_1_s_35 < 2) {
      A_shared_dyn_local[(ax0_1_s_35 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_35 * 20)) + 6403)];
    }
  }
  ...
  for (int ax0_1_s_36 = 0; ax0_1_s_36 < 4; ++ax0_1_s_36) {
    if (ax0_1_s_36 < 2) {
      A_shared_dyn_local[ax0_1_s_36] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_36 * 20)) + 6416)];
    }
  }
  ...
  for (int ax0_1_s_37 = 0; ax0_1_s_37 < 4; ++ax0_1_s_37) {
    if (ax0_1_s_37 < 2) {
      A_shared_dyn_local[(ax0_1_s_37 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_37 * 20)) + 6417)];
    }
  }
  ...
  for (int ax0_1_s_38 = 0; ax0_1_s_38 < 4; ++ax0_1_s_38) {
    if (ax0_1_s_38 < 2) {
      A_shared_dyn_local[ax0_1_s_38] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_38 * 20)) + 6418)];
    }
  }
  ...
  for (int ax0_1_s_39 = 0; ax0_1_s_39 < 4; ++ax0_1_s_39) {
    if (ax0_1_s_39 < 2) {
      A_shared_dyn_local[(ax0_1_s_39 + 2)] = ((float*)buf_dyn_shmem)[(((((((int)threadIdx.x) >> 4) * 80) + ((((int)threadIdx.x) & 1) * 40)) + (ax0_1_s_39 * 20)) + 6419)];
    }
  }
  ...
  for (int ax1_0_40 = 0; ax1_0_40 < 2; ++ax1_0_40) {
    *(float4*)(Y + (((((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 4) * 2048)) + ((((int)threadIdx.x) & 1) * 1024)) + ((((int)blockIdx.x) & 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + (ax1_0_40 * 4))) = *(float4*)(Y_local + (ax1_0_40 * 4));
  }
  for (int ax1_0_41 = 0; ax1_0_41 < 2; ++ax1_0_41) {
    *(float4*)(Y + ((((((((((int)blockIdx.x) >> 3) * 32768) + ((((int)threadIdx.x) >> 4) * 2048)) + ((((int)threadIdx.x) & 1) * 1024)) + ((((int)blockIdx.x) & 7) * 64)) + (((((int)threadIdx.x) & 15) >> 1) * 8)) + (ax1_0_41 * 4)) + 512)) = *(float4*)(Y_local + ((ax1_0_41 * 4) + 8));
  }
}
