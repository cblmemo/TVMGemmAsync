        ...
        for i_0_j_0_fused in T.thread_binding(256, thread="blockIdx.x"):
            for j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused in T.thread_binding(384, thread="threadIdx.x"):
                for j_2_init in T.unroll(12):
                    for i_2_0_init in T.unroll(2):
                        for i_2_1_init in T.unroll(4):
                            with T.block("Y_init"):
                                v_i = T.axis.spatial(3072, i_0_j_0_fused // 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 192 // 96 * 48 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 96 // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + i_2_0_init * 4 + i_2_1_init)
                                v_j = T.axis.spatial(3072, i_0_j_0_fused % 8 * 384 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 192 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + j_2_init)
                                T.reads()
                ...
                for k_0 in T.serial(768, annotations={"software_pipeline_async_stages":[0, 1], "software_pipeline_order":[0, 1, 3, 2, 4], "software_pipeline_stage":[0, 0, 2, 3, 3]}):
                    for ax0_0_ax1_fused in T.thread_binding(384, thread="threadIdx.x"):
                        for ax0_1 in T.unroll(1):
                            with T.block("A_shared.dyn"):
                                v0 = T.axis.spatial(3072, i_0_j_0_fused // 8 * 96 + ax0_0_ax1_fused // 4 + ax0_1)
                                v1 = T.axis.spatial(3072, k_0 * 4 + ax0_0_ax1_fused % 4)
                                T.reads(A[v0, v1])
                    ...
                    for ax0_ax1_fused_0_ax0_ax1_fused_1_fused in T.thread_binding(384, thread="threadIdx.x"):
                        for ax0_ax1_fused_2 in T.vectorized(4):
                            with T.block("B_shared.dyn"):
                                v0 = T.axis.spatial(3072, k_0 * 4 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 32 * 128 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 32 * 4 + ax0_ax1_fused_2) // 384)
                                v1 = T.axis.spatial(3072, i_0_j_0_fused % 8 * 384 + (ax0_ax1_fused_0_ax0_ax1_fused_1_fused // 32 * 128 + ax0_ax1_fused_0_ax0_ax1_fused_1_fused % 32 * 4 + ax0_ax1_fused_2) % 384)
                                T.reads(B[v0, v1])
                            ...
                            for ax0_1 in T.vectorized(4):
                                for ax1 in T.serial(1):
                                    with T.block("A_shared.dyn_local"):
                                        v0 = T.axis.spatial(3072, i_0_j_0_fused // 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 192 // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + ax0_0 * 4 + ax0_1)
                        ...
                        for ax0, ax1_0 in T.grid(1, 3):
                            for ax1_1 in T.vectorized(4):
                                with T.block("B_shared.dyn_local"):
                                    ...
                                    v1 = T.axis.spatial(3072, i_0_j_0_fused % 8 * 384 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 192 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + ax1_0 * 4 + ax1_1)
                            ...
                            for i_2_0 in T.unroll(2):
                                for i_2_1 in T.vectorized(4):
                                    with T.block("Y_update"):
                                        v_i = T.axis.spatial(3072, i_0_j_0_fused // 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 192 // 96 * 48 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 96 // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + i_2_0 * 4 + i_2_1)
                                        v_j = T.axis.spatial(3072, i_0_j_0_fused % 8 * 384 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 192 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + j_2)
                    ...
                    for ax1_0 in T.unroll(3):
                        for ax1_1 in T.vectorized(4):
                            with T.block("Y_local"):
                                v0 = T.axis.spatial(3072, i_0_j_0_fused // 8 * 96 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 192 // 32 * 16 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 2 * 8 + ax0)
                                v1 = T.axis.spatial(3072, i_0_j_0_fused % 8 * 384 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused // 192 * 192 + j_1_0_i_1_0_fused_i_1_1_j_1_1_i_1_2_fused_fused % 32 // 2 * 12 + ax1_0 * 4 + ax1_1)
