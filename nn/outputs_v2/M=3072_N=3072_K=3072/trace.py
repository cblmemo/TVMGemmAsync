...
def apply_trace(sch: tir.Schedule) -> None:
  ...
  v9, v10, v11 = sch.sample_perfect_tile(loop=l6, n=3, max_innermost_factor=16, decision=[16, 16, 12])
  v12, v13, v14 = sch.sample_perfect_tile(loop=l7, n=3, max_innermost_factor=16, decision=[16, 24, 8])
  v15, v16 = sch.sample_perfect_tile(loop=l8, n=2, max_innermost_factor=8, decision=[512, 6])
  ...
  v26, v27, v28 = sch.sample_perfect_tile(loop=l18, n=3, max_innermost_factor=2, decision=[16, 1, 1])
  v29, v30 = sch.sample_perfect_tile(loop=l21, n=2, max_innermost_factor=16, decision=[12, 2])
  ...
  v60, v61 = sch.sample_perfect_tile(loop=l58, n=2, max_innermost_factor=16, decision=[64, 3])
