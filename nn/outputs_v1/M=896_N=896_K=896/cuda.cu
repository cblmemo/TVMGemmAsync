...
#endif
extern "C" __global__ void __launch_bounds__(224) main_kernel0(float* __restrict__ A, float* __restrict__ B, float* __restrict__ Y) {
...

  {
    ...
    __asm__ __volatile__(
      ...
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)))), "n"(4)
    );
  }
  }
  if (((int)threadIdx.x) < 128) {

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 256)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 1))), "n"(4)
    );
  }
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) / 56) * 1024) + (((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) % 56) * 4)) >> 6) * 256)) + ((((int)threadIdx.x) & 1) * 128)) + (((((((int)blockIdx.x) & 3) * 4) + ((((int)threadIdx.x) % 56) >> 1)) & 7) * 16)) + 5120) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 256))))
    );
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + ((((((int)threadIdx.x) / 56) * 896) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) % 56) * 4)))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 1024)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 4))), "n"(4)
    );
  }
  }
  if (((int)threadIdx.x) < 128) {

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 1280)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 5))), "n"(4)
    );
  }
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) / 56) * 1024) + (((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) % 56) * 4)) >> 6) * 256)) + ((((int)threadIdx.x) & 1) * 128)) + (((((((int)blockIdx.x) & 3) * 4) + ((((int)threadIdx.x) % 56) >> 1)) & 7) * 16)) + 9216) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 256))))
    );
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) / 56) * 896) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) % 56) * 4)) + 3584))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 2048)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 8))), "n"(4)
    );
  }
  }
  if (((int)threadIdx.x) < 128) {

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 2304)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 9))), "n"(4)
    );
  }
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) / 56) * 1024) + (((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) % 56) * 4)) >> 6) * 256)) + ((((int)threadIdx.x) & 1) * 128)) + (((((((int)blockIdx.x) & 3) * 4) + ((((int)threadIdx.x) % 56) >> 1)) & 7) * 16)) + 13312) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 256))))
    );
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) / 56) * 896) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) % 56) * 4)) + 7168))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 3072)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 12))), "n"(4)
    );
  }
  }
  if (((int)threadIdx.x) < 128) {

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) & 1) * 512) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 3328)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + (((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + ((((int)threadIdx.x) & 1) * 2)) + 13))), "n"(4)
    );
  }
  }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((int)threadIdx.x) / 56) * 1024) + (((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) % 56) * 4)) >> 6) * 256)) + ((((int)threadIdx.x) & 1) * 128)) + (((((((int)blockIdx.x) & 3) * 4) + ((((int)threadIdx.x) % 56) >> 1)) & 7) * 16)) + 17408) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 256))))
    );
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((((int)threadIdx.x) / 56) * 896) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) % 56) * 4)) + 10752))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
  ...
  for (int ax0_0 = 0; ax0_0 < 2; ++ax0_0) {
    A_shared_dyn_local[ax0_0] = *(float4*)(((float*)buf_dyn_shmem) + (((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)));
  }
  for (int ax1_0 = 0; ax1_0 < 2; ++ax1_0) {
    *(float4*)(B_shared_dyn_local + (ax1_0 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0 * 4)) >> 6) * 64) + (ax1_0 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 1280) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  for (int k_0 = 0; k_0 < 220; ++k_0) {
    __syncthreads();
    if (((int)threadIdx.x) < 128) {

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + ((((((((k_0 + 4) % 5) * 1024) + ((((int)threadIdx.x) & 1) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4))))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + (k_0 * 4)) + ((((int)threadIdx.x) & 1) * 2)) + 16))), "n"(4)
    );
  }
    }
    if (((int)threadIdx.x) < 128) {

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((k_0 + 4) % 5) * 1024) + ((((int)threadIdx.x) & 1) * 512)) + ((((int)threadIdx.x) >> 6) * 128)) + ((((((((int)threadIdx.x) / 28) * 3) + ((((int)threadIdx.x) % 28) >> 2)) & 3) >> 1) * 64)) + (((((int)threadIdx.x) & 63) >> 4) * 16)) + (((((((int)threadIdx.x) / 28) * 2) + ((((int)threadIdx.x) % 28) >> 1)) & 3) * 4)) + 256)))
    );
    __asm__ __volatile__(
      "cp.async.ca.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(A + ((((((((int)blockIdx.x) >> 2) * 57344) + ((((int)threadIdx.x) >> 1) * 896)) + (k_0 * 4)) + ((((int)threadIdx.x) & 1) * 2)) + 17))), "n"(4)
    );
  }
    }

  {
    ...
    __asm__ __volatile__(
      "{ .reg .u64 addr; cvta.to.shared.u64 addr, %1; cvt.u32.u64 %0, addr; }\n"
      : "=r"(addr)
      : "l"((void *)(buf_dyn_shmem + (((((((((k_0 + 4) % 5) * 4096) + ((((int)threadIdx.x) / 56) * 1024)) + (((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) % 56) * 4)) >> 6) * 256)) + ((((int)threadIdx.x) & 1) * 128)) + (((((((int)blockIdx.x) & 3) * 4) + ((((int)threadIdx.x) % 56) >> 1)) & 7) * 16)) + 5120) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 256))))
    );
    __asm__ __volatile__(
      "cp.async.cg.shared.global [%0], [%1], %2;"
       :: "r"(addr), "l"((void*)(B + (((((k_0 * 3584) + ((((int)threadIdx.x) / 56) * 896)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) % 56) * 4)) + 14336))), "n"(16)
    );
  }
__asm__ __volatile__("cp.async.commit_group;");
...
__asm__ __volatile__("cp.async.wait_group 3;");
    ...
    for (int ax0_0_1 = 0; ax0_0_1 < 2; ++ax0_0_1) {
      A_shared_dyn_local[(ax0_0_1 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 256) + (((((int)threadIdx.x) & 15) >> 3) * 32)) + (ax0_0_1 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 64));
    }
    for (int ax1_0_1 = 0; ax1_0_1 < 2; ++ax1_0_1) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_1 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 % 5) * 1024) + (((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_1 * 4)) >> 6) * 64)) + (ax1_0_1 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 1536) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
    }
    ...
    for (int ax0_0_2 = 0; ax0_0_2 < 2; ++ax0_0_2) {
      A_shared_dyn_local[ax0_0_2] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 256) + (((((int)threadIdx.x) & 15) >> 3) * 32)) + (ax0_0_2 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 128));
    }
    for (int ax1_0_2 = 0; ax1_0_2 < 2; ++ax1_0_2) {
      *(float4*)(B_shared_dyn_local + (ax1_0_2 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 % 5) * 1024) + (((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_2 * 4)) >> 6) * 64)) + (ax1_0_2 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 1792) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
    }
    ...
    for (int ax0_0_3 = 0; ax0_0_3 < 2; ++ax0_0_3) {
      A_shared_dyn_local[(ax0_0_3 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 % 5) * 256) + (((((int)threadIdx.x) & 15) >> 3) * 32)) + (ax0_0_3 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 192));
    }
    for (int ax1_0_3 = 0; ax1_0_3 < 2; ++ax1_0_3) {
      *(float4*)(B_shared_dyn_local + ((ax1_0_3 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((k_0 % 5) * 1024) + (((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_3 * 4)) >> 6) * 64)) + (ax1_0_3 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 2048) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
    }
    ...
    for (int ax0_0_4 = 0; ax0_0_4 < 2; ++ax0_0_4) {
      A_shared_dyn_local[ax0_0_4] = *(float4*)(((float*)buf_dyn_shmem) + ((((((k_0 + 1) % 5) * 256) + (((((int)threadIdx.x) & 15) >> 3) * 32)) + (ax0_0_4 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)));
    }
    for (int ax1_0_4 = 0; ax1_0_4 < 2; ++ax1_0_4) {
      *(float4*)(B_shared_dyn_local + (ax1_0_4 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + ((((((((k_0 + 1) % 5) * 1024) + (((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_4 * 4)) >> 6) * 64)) + (ax1_0_4 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 1280) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
    }
...
__asm__ __volatile__("cp.async.wait_group 2;");
  ...
  for (int ax0_0_5 = 0; ax0_0_5 < 2; ++ax0_0_5) {
    A_shared_dyn_local[(ax0_0_5 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_5 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 64));
  }
  for (int ax1_0_5 = 0; ax1_0_5 < 2; ++ax1_0_5) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_5 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_5 * 4)) >> 6) * 64) + (ax1_0_5 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 1536) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_6 = 0; ax0_0_6 < 2; ++ax0_0_6) {
    A_shared_dyn_local[ax0_0_6] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_6 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 128));
  }
  for (int ax1_0_6 = 0; ax1_0_6 < 2; ++ax1_0_6) {
    *(float4*)(B_shared_dyn_local + (ax1_0_6 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_6 * 4)) >> 6) * 64) + (ax1_0_6 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 1792) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_7 = 0; ax0_0_7 < 2; ++ax0_0_7) {
    A_shared_dyn_local[(ax0_0_7 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_7 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 192));
  }
  for (int ax1_0_7 = 0; ax1_0_7 < 2; ++ax1_0_7) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_7 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_7 * 4)) >> 6) * 64) + (ax1_0_7 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 2048) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_8 = 0; ax0_0_8 < 2; ++ax0_0_8) {
    A_shared_dyn_local[ax0_0_8] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_8 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 256));
  }
  for (int ax1_0_8 = 0; ax1_0_8 < 2; ++ax1_0_8) {
    *(float4*)(B_shared_dyn_local + (ax1_0_8 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_8 * 4)) >> 6) * 64) + (ax1_0_8 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 2304) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
  ...
  for (int ax0_0_9 = 0; ax0_0_9 < 2; ++ax0_0_9) {
    A_shared_dyn_local[(ax0_0_9 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_9 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 320));
  }
  for (int ax1_0_9 = 0; ax1_0_9 < 2; ++ax1_0_9) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_9 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_9 * 4)) >> 6) * 64) + (ax1_0_9 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 2560) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_10 = 0; ax0_0_10 < 2; ++ax0_0_10) {
    A_shared_dyn_local[ax0_0_10] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_10 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 384));
  }
  for (int ax1_0_10 = 0; ax1_0_10 < 2; ++ax1_0_10) {
    *(float4*)(B_shared_dyn_local + (ax1_0_10 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_10 * 4)) >> 6) * 64) + (ax1_0_10 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 2816) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_11 = 0; ax0_0_11 < 2; ++ax0_0_11) {
    A_shared_dyn_local[(ax0_0_11 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_11 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 448));
  }
  for (int ax1_0_11 = 0; ax1_0_11 < 2; ++ax1_0_11) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_11 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_11 * 4)) >> 6) * 64) + (ax1_0_11 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 3072) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_12 = 0; ax0_0_12 < 2; ++ax0_0_12) {
    A_shared_dyn_local[ax0_0_12] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_12 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 512));
  }
  for (int ax1_0_12 = 0; ax1_0_12 < 2; ++ax1_0_12) {
    *(float4*)(B_shared_dyn_local + (ax1_0_12 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_12 * 4)) >> 6) * 64) + (ax1_0_12 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 3328) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
...
__asm__ __volatile__("cp.async.wait_group 0;");
  ...
  for (int ax0_0_13 = 0; ax0_0_13 < 2; ++ax0_0_13) {
    A_shared_dyn_local[(ax0_0_13 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_13 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 576));
  }
  for (int ax1_0_13 = 0; ax1_0_13 < 2; ++ax1_0_13) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_13 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_13 * 4)) >> 6) * 64) + (ax1_0_13 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 3584) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_14 = 0; ax0_0_14 < 2; ++ax0_0_14) {
    A_shared_dyn_local[ax0_0_14] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_14 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 640));
  }
  for (int ax1_0_14 = 0; ax1_0_14 < 2; ++ax1_0_14) {
    *(float4*)(B_shared_dyn_local + (ax1_0_14 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_14 * 4)) >> 6) * 64) + (ax1_0_14 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 3840) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_15 = 0; ax0_0_15 < 2; ++ax0_0_15) {
    A_shared_dyn_local[(ax0_0_15 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_15 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 704));
  }
  for (int ax1_0_15 = 0; ax1_0_15 < 2; ++ax1_0_15) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_15 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_15 * 4)) >> 6) * 64) + (ax1_0_15 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 4096) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_16 = 0; ax0_0_16 < 2; ++ax0_0_16) {
    A_shared_dyn_local[ax0_0_16] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_16 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 768));
  }
  for (int ax1_0_16 = 0; ax1_0_16 < 2; ++ax1_0_16) {
    *(float4*)(B_shared_dyn_local + (ax1_0_16 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_16 * 4)) >> 6) * 64) + (ax1_0_16 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 4352) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_17 = 0; ax0_0_17 < 2; ++ax0_0_17) {
    A_shared_dyn_local[(ax0_0_17 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_17 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 832));
  }
  for (int ax1_0_17 = 0; ax1_0_17 < 2; ++ax1_0_17) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_17 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_17 * 4)) >> 6) * 64) + (ax1_0_17 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 4608) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_18 = 0; ax0_0_18 < 2; ++ax0_0_18) {
    A_shared_dyn_local[ax0_0_18] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_18 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 896));
  }
  for (int ax1_0_18 = 0; ax1_0_18 < 2; ++ax1_0_18) {
    *(float4*)(B_shared_dyn_local + (ax1_0_18 * 4)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_18 * 4)) >> 6) * 64) + (ax1_0_18 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 4864) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  for (int ax0_0_19 = 0; ax0_0_19 < 2; ++ax0_0_19) {
    A_shared_dyn_local[(ax0_0_19 + 2)] = *(float4*)(((float*)buf_dyn_shmem) + ((((((((int)threadIdx.x) & 15) >> 3) * 32) + (ax0_0_19 * 16)) + (((((int)threadIdx.x) & 7) >> 1) * 4)) + 960));
  }
  for (int ax1_0_19 = 0; ax1_0_19 < 2; ++ax1_0_19) {
    *(float4*)(B_shared_dyn_local + ((ax1_0_19 * 4) + 8)) = *(float4*)(((float*)buf_dyn_shmem) + (((((((((((((int)blockIdx.x) & 3) * 224) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + (ax1_0_19 * 4)) >> 6) * 64) + (ax1_0_19 * 32)) + ((((((((int)blockIdx.x) & 3) * 28) + ((((int)threadIdx.x) >> 4) * 2)) + (((int)threadIdx.x) & 1)) & 7) * 4)) + 5120) - ((((((int)blockIdx.x) & 3) * 224) >> 6) * 64)));
  }
  ...
  *(float4*)(Y + ((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8))) = *(float4*)(Y_local + 0);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 4)) = *(float4*)(Y_local + 4);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 896)) = *(float4*)(Y_local + 8);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 900)) = *(float4*)(Y_local + 12);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 1792)) = *(float4*)(Y_local + 16);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 1796)) = *(float4*)(Y_local + 20);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 2688)) = *(float4*)(Y_local + 24);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 2692)) = *(float4*)(Y_local + 28);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 3584)) = *(float4*)(Y_local + 32);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 3588)) = *(float4*)(Y_local + 36);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 4480)) = *(float4*)(Y_local + 40);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 4484)) = *(float4*)(Y_local + 44);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 5376)) = *(float4*)(Y_local + 48);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 5380)) = *(float4*)(Y_local + 52);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 6272)) = *(float4*)(Y_local + 56);
  *(float4*)(Y + (((((((((int)blockIdx.x) >> 2) * 57344) + (((((int)threadIdx.x) & 15) >> 1) * 7168)) + ((((int)blockIdx.x) & 3) * 224)) + ((((int)threadIdx.x) >> 4) * 16)) + ((((int)threadIdx.x) & 1) * 8)) + 6276)) = *(float4*)(Y_local + 60);
}
